...
\label{mpu__armv7_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/mpu\_armv7.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/mpu\_armv7.h}}
...
\DoxyCodeLine{181   uint32\_t RBAR; }
\DoxyCodeLine{182   uint32\_t RASR; }
\DoxyCodeLine{183 \} ARM\_MPU\_Region\_t;}
\DoxyCodeLine{184     }
\DoxyCodeLine{188 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Enable(uint32\_t MPU\_Control)}
\DoxyCodeLine{189 \{}
\DoxyCodeLine{190   \_\_DSB();}
\DoxyCodeLine{191   \_\_ISB();}
...
\DoxyCodeLine{194   SCB-\/>SHCSR |= SCB\_SHCSR\_MEMFAULTENA\_Msk;}
...
\DoxyCodeLine{201 \{}
\DoxyCodeLine{202   \_\_DSB();}
\DoxyCodeLine{203   \_\_ISB();}
\DoxyCodeLine{204 \textcolor{preprocessor}{\#ifdef SCB\_SHCSR\_MEMFAULTENA\_Msk}}
\DoxyCodeLine{205   SCB-\/>SHCSR \&= \string~SCB\_SHCSR\_MEMFAULTENA\_Msk;}
...
\DoxyCodeLine{253 \}}
\DoxyCodeLine{254 }
\DoxyCodeLine{259 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Load(ARM\_MPU\_Region\_t \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{260 \{}
\DoxyCodeLine{261   \textcolor{keyword}{const} uint32\_t rowWordSize = \textcolor{keyword}{sizeof}(ARM\_MPU\_Region\_t)/4U;}
\DoxyCodeLine{262   \textcolor{keywordflow}{while} (cnt > MPU\_TYPE\_RALIASES) \{}
\DoxyCodeLine{263     orderedCpy(\&(MPU-\/>RBAR), \&(table-\/>RBAR), MPU\_TYPE\_RALIASES*rowWordSize);}
\DoxyCodeLine{264     table += MPU\_TYPE\_RALIASES;}
\DoxyCodeLine{265     cnt -\/= MPU\_TYPE\_RALIASES;}
\DoxyCodeLine{266   \}}
\DoxyCodeLine{267   orderedCpy(\&(MPU-\/>RBAR), \&(table-\/>RBAR), cnt*rowWordSize);}
\DoxyCodeLine{268 \}}
\DoxyCodeLine{269 }
