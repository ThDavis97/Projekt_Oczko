...
\begin{DoxyPre}
BaseType\_t \doxyref{xStreamBufferSetTriggerLevel( StreamBufferHandle\_t xStreamBuffer, size\_t xTriggerLevel )}{p.}{stream__buffer_8h_a28f0280587c76e71efeaa8f415ebde04};
\end{DoxyPre}
...
A trigger level is set when the stream buffer is created, and can be modified using \doxyref{x\+Stream\+Buffer\+Set\+Trigger\+Level()}{p.}{stream__buffer_8h_a28f0280587c76e71efeaa8f415ebde04}.
