...
\begin{DoxyPre}
   EventBits\_t \doxyref{xEventGroupSync( EventGroupHandle\_t xEventGroup,                                 const EventBits\_t uxBitsToSet,                                 const EventBits\_t uxBitsToWaitFor,                                 TickType\_t xTicksToWait )}{p.}{event__groups_8h_a869511456b86426f52e2eec898bff341};
\end{DoxyPre}
...
The value of the event group at the time either the bits being waited for became set, or the block time expired. Test the return value to know which bits were set. If \doxyref{x\+Event\+Group\+Sync()}{p.}{event__groups_8h_a869511456b86426f52e2eec898bff341} returned because its timeout expired then not all the bits being waited for will be set. If \doxyref{x\+Event\+Group\+Sync()}{p.}{event__groups_8h_a869511456b86426f52e2eec898bff341} returned because all the bits it was waiting for were set then the returned value is the event group value before any bits were automatically cleared.
\end{DoxyReturn}
Example usage\+: 
\begin{DoxyPre}
...
TickType\_t xTicksToWait = 100 / portTICK\_PERIOD\_MS;
    ...
    \{
        ...
        // to \doxyref{xEventGroupSync()}{p.}{event__groups_8h_a869511456b86426f52e2eec898bff341} timed out.
    \}
   \}
\}
...
\{
    ...
    // \doxyref{xEventGroupSync()}{p.}{event__groups_8h_a869511456b86426f52e2eec898bff341} was called with an indefinite block time, so
