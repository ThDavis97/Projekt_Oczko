...
task. h 
\begin{DoxyPre}void \doxyref{xTaskResumeFromISR( TaskHandle\_t xTaskToResume )}{p.}{task_8h_aefbfd37c0661c3062fafd7334bff9aed};\end{DoxyPre}
...
An implementation of \doxyref{v\+Task\+Resume()}{p.}{task_8h_a84a1584f29fb7736a1aa72ad5b3e9b44} that can be called from within an ISR.
...
\doxyref{x\+Task\+Resume\+From\+ISR()}{p.}{task_8h_aefbfd37c0661c3062fafd7334bff9aed} should not be used to synchronise a task with an interrupt if there is a chance that the interrupt could arrive prior to the task being suspended -\/ as this can lead to interrupts being missed. Use of a semaphore as a synchronisation mechanism would avoid this eventuality.
