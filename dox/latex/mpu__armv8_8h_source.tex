...
\label{mpu__armv8_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/mpu\_armv8.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/mpu\_armv8.h}}
...
\DoxyCodeLine{109   uint32\_t RLAR;                   }
\DoxyCodeLine{110 \} ARM\_MPU\_Region\_t;}
\DoxyCodeLine{111     }
\DoxyCodeLine{115 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Enable(uint32\_t MPU\_Control)}
\DoxyCodeLine{116 \{}
\DoxyCodeLine{117   \_\_DSB();}
\DoxyCodeLine{118   \_\_ISB();}
...
\DoxyCodeLine{121   SCB-\/>SHCSR |= SCB\_SHCSR\_MEMFAULTENA\_Msk;}
...
\DoxyCodeLine{128 \{}
\DoxyCodeLine{129   \_\_DSB();}
\DoxyCodeLine{130   \_\_ISB();}
\DoxyCodeLine{131 \textcolor{preprocessor}{\#ifdef SCB\_SHCSR\_MEMFAULTENA\_Msk}}
\DoxyCodeLine{132   SCB-\/>SHCSR \&= \string~SCB\_SHCSR\_MEMFAULTENA\_Msk;}
...
\DoxyCodeLine{142 \{}
\DoxyCodeLine{143   \_\_DSB();}
\DoxyCodeLine{144   \_\_ISB();}
...
\DoxyCodeLine{147   SCB\_NS-\/>SHCSR |= SCB\_SHCSR\_MEMFAULTENA\_Msk;}
...
\DoxyCodeLine{154 \{}
\DoxyCodeLine{155   \_\_DSB();}
\DoxyCodeLine{156   \_\_ISB();}
...
\DoxyCodeLine{277 \}}
\DoxyCodeLine{278 }
\DoxyCodeLine{285 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_LoadEx(MPU\_Type* mpu, uint32\_t rnr, ARM\_MPU\_Region\_t \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{286 \{}
\DoxyCodeLine{287   \textcolor{keyword}{const} uint32\_t rowWordSize = \textcolor{keyword}{sizeof}(ARM\_MPU\_Region\_t)/4U;}
\DoxyCodeLine{288   \textcolor{keywordflow}{if} (cnt == 1U) \{}
\DoxyCodeLine{289     mpu-\/>RNR = rnr;}
\DoxyCodeLine{290     orderedCpy(\&(mpu-\/>RBAR), \&(table-\/>RBAR), rowWordSize);}
...
\DoxyCodeLine{298       orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>RBAR), c*rowWordSize);}
...
\DoxyCodeLine{304     \}}
\DoxyCodeLine{305     }
\DoxyCodeLine{306     orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>RBAR), cnt*rowWordSize);}
\DoxyCodeLine{307   \}}
\DoxyCodeLine{308 \}}
\DoxyCodeLine{309 }
\DoxyCodeLine{315 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Load(uint32\_t rnr, ARM\_MPU\_Region\_t \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{316 \{}
\DoxyCodeLine{317   ARM\_MPU\_LoadEx(MPU, rnr, table, cnt);}
\DoxyCodeLine{318 \}}
\DoxyCodeLine{319 }
\DoxyCodeLine{320 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{326 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} ARM\_MPU\_Load\_NS(uint32\_t rnr, ARM\_MPU\_Region\_t \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{327 \{}
