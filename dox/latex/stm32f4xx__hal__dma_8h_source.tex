...
\label{stm32f4xx__hal__dma_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/STM32F4xx\_HAL\_Driver/Inc/stm32f4xx\_hal\_dma.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/STM32F4xx\_HAL\_Driver/Inc/stm32f4xx\_hal\_dma.h}}
...
\DoxyCodeLine{50 \{}
\DoxyCodeLine{51   uint32\_t Channel;              }
\DoxyCodeLine{54   uint32\_t Direction;            }
\DoxyCodeLine{58   uint32\_t PeriphInc;            }
\DoxyCodeLine{61   uint32\_t MemInc;               }
\DoxyCodeLine{64   uint32\_t PeriphDataAlignment;  }
\DoxyCodeLine{67   uint32\_t MemDataAlignment;     }
\DoxyCodeLine{70   uint32\_t Mode;                 }
\DoxyCodeLine{75   uint32\_t Priority;             }
\DoxyCodeLine{78   uint32\_t FIFOMode;             }
\DoxyCodeLine{83   uint32\_t FIFOThreshold;        }
\DoxyCodeLine{86   uint32\_t MemBurst;             }
\DoxyCodeLine{92   uint32\_t PeriphBurst;          }
\DoxyCodeLine{97 \}DMA\_InitTypeDef;}
\DoxyCodeLine{98 }
\DoxyCodeLine{99 }
\DoxyCodeLine{103 \textcolor{keyword}{typedef} \textcolor{keyword}{enum}}
\DoxyCodeLine{104 \{}
\DoxyCodeLine{105   HAL\_DMA\_STATE\_RESET             = 0x00U,  }
\DoxyCodeLine{106   HAL\_DMA\_STATE\_READY             = 0x01U,  }
\DoxyCodeLine{107   HAL\_DMA\_STATE\_BUSY              = 0x02U,  }
\DoxyCodeLine{108   HAL\_DMA\_STATE\_TIMEOUT           = 0x03U,  }
\DoxyCodeLine{109   HAL\_DMA\_STATE\_ERROR             = 0x04U,  }
\DoxyCodeLine{110   HAL\_DMA\_STATE\_ABORT             = 0x05U,  }
\DoxyCodeLine{111 \}HAL\_DMA\_StateTypeDef;}
\DoxyCodeLine{112 }
\DoxyCodeLine{116 \textcolor{keyword}{typedef} \textcolor{keyword}{enum}}
\DoxyCodeLine{117 \{}
\DoxyCodeLine{118   HAL\_DMA\_FULL\_TRANSFER           = 0x00U,  }
\DoxyCodeLine{119   HAL\_DMA\_HALF\_TRANSFER           = 0x01U   }
\DoxyCodeLine{120 \}HAL\_DMA\_LevelCompleteTypeDef;}
\DoxyCodeLine{121 }
\DoxyCodeLine{125 \textcolor{keyword}{typedef} \textcolor{keyword}{enum}}
\DoxyCodeLine{126 \{}
\DoxyCodeLine{127   HAL\_DMA\_XFER\_CPLT\_CB\_ID         = 0x00U,  }
\DoxyCodeLine{128   HAL\_DMA\_XFER\_HALFCPLT\_CB\_ID     = 0x01U,  }
\DoxyCodeLine{129   HAL\_DMA\_XFER\_M1CPLT\_CB\_ID       = 0x02U,  }
\DoxyCodeLine{130   HAL\_DMA\_XFER\_M1HALFCPLT\_CB\_ID   = 0x03U,  }
\DoxyCodeLine{131   HAL\_DMA\_XFER\_ERROR\_CB\_ID        = 0x04U,  }
\DoxyCodeLine{132   HAL\_DMA\_XFER\_ABORT\_CB\_ID        = 0x05U,  }
\DoxyCodeLine{133   HAL\_DMA\_XFER\_ALL\_CB\_ID          = 0x06U   }
\DoxyCodeLine{134 \}HAL\_DMA\_CallbackIDTypeDef;}
\DoxyCodeLine{135 }
\DoxyCodeLine{139 \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef}
\DoxyCodeLine{140 \{}
\DoxyCodeLine{141   DMA\_Stream\_TypeDef         *Instance;                                                        }
\DoxyCodeLine{143   DMA\_InitTypeDef            Init;                                                             }
\DoxyCodeLine{145   HAL\_LockTypeDef            Lock;                                                             }
\DoxyCodeLine{147   \_\_IO HAL\_DMA\_StateTypeDef  State;                                                            }
\DoxyCodeLine{149   \textcolor{keywordtype}{void}                       *Parent;                                                          }
\DoxyCodeLine{151   void                       (* XferCpltCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);         }
\DoxyCodeLine{153   void                       (* XferHalfCpltCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);     }
\DoxyCodeLine{155   void                       (* XferM1CpltCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);       }
\DoxyCodeLine{157   void                       (* XferM1HalfCpltCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);   }
\DoxyCodeLine{159   void                       (* XferErrorCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);        }
\DoxyCodeLine{161   void                       (* XferAbortCallback)( \textcolor{keyword}{struct }\_\_DMA\_HandleTypeDef * hdma);        }
\DoxyCodeLine{163   \_\_IO uint32\_t              ErrorCode;                                                        }
\DoxyCodeLine{165   uint32\_t                   StreamBaseAddress;                                                }
\DoxyCodeLine{167   uint32\_t                   StreamIndex;                                                      }
\DoxyCodeLine{169 \}DMA\_HandleTypeDef;}
\DoxyCodeLine{170 }
...
\DoxyCodeLine{640 \textcolor{preprocessor}{\#include "{}stm32f4xx\_hal\_dma\_ex.h"{}}   }
\DoxyCodeLine{641 }
\DoxyCodeLine{642 \textcolor{comment}{/* Exported functions -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{643 }
\DoxyCodeLine{653 HAL\_StatusTypeDef HAL\_DMA\_Init(DMA\_HandleTypeDef *hdma); }
\DoxyCodeLine{654 HAL\_StatusTypeDef HAL\_DMA\_DeInit(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{663 HAL\_StatusTypeDef HAL\_DMA\_Start (DMA\_HandleTypeDef *hdma, uint32\_t SrcAddress, uint32\_t DstAddress, uint32\_t DataLength);}
\DoxyCodeLine{664 HAL\_StatusTypeDef HAL\_DMA\_Start\_IT(DMA\_HandleTypeDef *hdma, uint32\_t SrcAddress, uint32\_t DstAddress, uint32\_t DataLength);}
\DoxyCodeLine{665 HAL\_StatusTypeDef HAL\_DMA\_Abort(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{666 HAL\_StatusTypeDef HAL\_DMA\_Abort\_IT(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{667 HAL\_StatusTypeDef HAL\_DMA\_PollForTransfer(DMA\_HandleTypeDef *hdma, HAL\_DMA\_LevelCompleteTypeDef CompleteLevel, uint32\_t Timeout);}
\DoxyCodeLine{668 \textcolor{keywordtype}{void}              HAL\_DMA\_IRQHandler(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{669 HAL\_StatusTypeDef HAL\_DMA\_CleanCallbacks(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{670 HAL\_StatusTypeDef HAL\_DMA\_RegisterCallback(DMA\_HandleTypeDef *hdma, HAL\_DMA\_CallbackIDTypeDef CallbackID, \textcolor{keywordtype}{void} (* pCallback)(DMA\_HandleTypeDef *\_hdma));}
\DoxyCodeLine{671 HAL\_StatusTypeDef HAL\_DMA\_UnRegisterCallback(DMA\_HandleTypeDef *hdma, HAL\_DMA\_CallbackIDTypeDef CallbackID);}
\DoxyCodeLine{672 }
\DoxyCodeLine{681 HAL\_DMA\_StateTypeDef HAL\_DMA\_GetState(DMA\_HandleTypeDef *hdma);}
\DoxyCodeLine{682 uint32\_t             HAL\_DMA\_GetError(DMA\_HandleTypeDef *hdma);}
