...
task. h 
\begin{DoxyPre}BaseType\_t \doxyref{xTaskNotifyWait( uint32\_t ulBitsToClearOnEntry, uint32\_t ulBitsToClearOnExit, uint32\_t *pulNotificationValue, TickType\_t xTicksToWait )}{p.}{task_8h_a0475fcda9718f403521c270a7270ff93};\end{DoxyPre}
...
\hline
{\em x\+Ticks\+To\+Wait} & The maximum amount of time that the task should wait in the Blocked state for a notification to be received, should a notification not already be pending when \doxyref{x\+Task\+Notify\+Wait()}{p.}{task_8h_a0475fcda9718f403521c270a7270ff93} was called. The task will not consume any processing time while it is in the Blocked state. This is specified in kernel ticks, the macro pd\+MS\+\_\+\+TO\+\_\+\+TICSK( value\+\_\+in\+\_\+ms ) can be used to convert a time specified in milliseconds to a time specified in ticks.\\
\hline
\end{DoxyParams}
...
\end{DoxyReturn}
task. h 
\begin{DoxyPre}void \doxyref{vTaskNotifyGiveFromISR( TaskHandle\_t xTaskHandle, BaseType\_t *pxHigherPriorityTaskWoken )}{p.}{task_8h_a4a4bcf98ad282a596e13f3f30582a11b};
...
A version of \doxyref{xTaskNotifyGive()}{p.}{task_8h_ac60cbd05577a3e4f3c3587dd9b213930} that can be called from an interrupt service
routine (ISR).
...
\doxyref{vTaskNotifyGiveFromISR()}{p.}{task_8h_a4a4bcf98ad282a596e13f3f30582a11b} is intended for use when task notifications are
used as light weight and faster binary or counting semaphore equivalents.
Actual FreeRTOS semaphores are given from an ISR using the
\doxyref{xSemaphoreGiveFromISR()}{p.}{semphr_8h_a68aa43df8b2a0dbe17d05fad74670ef0} API function, the equivalent action that instead uses
a task notification is \doxyref{vTaskNotifyGiveFromISR()}{p.}{task_8h_a4a4bcf98ad282a596e13f3f30582a11b}.

When task notifications are being used as a binary or counting semaphore
equivalent then the task being notified should wait for the notification
using the ulTaskNotificationTake() API function rather than the
\doxyref{xTaskNotifyWait()}{p.}{task_8h_a0475fcda9718f403521c270a7270ff93} API function.
...
\doxyref{xTaskGetCurrentTaskHandle()}{p.}{task_8h_a85a0f9c9f817b18686efbf8f37c72dfc}.

\\
\hline
{\em pxHigherPriorityTaskWoken} &  \doxyref{vTaskNotifyGiveFromISR()}{p.}{task_8h_a4a4bcf98ad282a596e13f3f30582a11b} will set
*pxHigherPriorityTaskWoken to pdTRUE if sending the notification caused the
task to which the notification was sent to leave the Blocked state, and the
unblocked task has a priority higher than the currently running task.  If
\doxyref{vTaskNotifyGiveFromISR()}{p.}{task_8h_a4a4bcf98ad282a596e13f3f30582a11b} sets this value to pdTRUE then a context switch
