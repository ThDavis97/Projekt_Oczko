...
\item 
\textbf{ Functional\+State} \textbf{ Continuous\+Conv\+Mode}
\item 
uint32\+\_\+t \textbf{ Nbr\+Of\+Conversion}
\item 
\textbf{ Functional\+State} \textbf{ Discontinuous\+Conv\+Mode}
\item 
...
\item 
\textbf{ Functional\+State} \textbf{ DMAContinuous\+Requests}
...
Select ADC clock prescaler. The clock is common for all the ADCs. This parameter can be a value of \doxyref{ADC Clock Prescaler}{p.}{group___a_d_c___clock_prescaler} \mbox{\label{struct_a_d_c___init_type_def_acb089820ffd05cfa35a3b0b89b7945fd}} 
...
{\footnotesize\ttfamily \textbf{ Functional\+State} Continuous\+Conv\+Mode}

Specifies whether the conversion is performed in single mode (one conversion) or continuous mode for regular group, after the selected trigger occurred (software start or external trigger). This parameter can be set to ENABLE or DISABLE. \mbox{\label{struct_a_d_c___init_type_def_afe646b2571044212378bf5f722544359}} 
...
Specifies ADC data alignment to right (MSB on register bit 11 and LSB on register bit 0) (default setting) or to left (if regular group\+: MSB on register bit 15 and LSB on register bit 4, if injected group (MSB kept as signed value due to potential negative value after offset application)\+: MSB on register bit 14 and LSB on register bit 3). This parameter can be a value of \doxyref{ADC Data Align}{p.}{group___a_d_c___data__align} \mbox{\label{struct_a_d_c___init_type_def_aa314a1478944f8457d9c9e423719d893}} 
...
{\footnotesize\ttfamily \textbf{ Functional\+State} DMAContinuous\+Requests}

Specifies whether the DMA requests are performed in one shot mode (DMA transfer stop when number of conversions is reached) or in Continuous mode (DMA transfer unlimited, whatever number of conversions). Note\+: In continuous mode, DMA must be configured in circular mode. Otherwise an overrun will be triggered when DMA buffer maximum pointer is reached. Note\+: This parameter must be modified when no conversion is on going on both regular and injected groups (ADC disabled, or ADC enabled without continuous mode or external trigger that could launch a conversion). This parameter can be set to ENABLE or DISABLE. \mbox{\label{struct_a_d_c___init_type_def_a92de48abe9cbd958145ce5bc090ea383}} 
...
Selects the external event used to trigger the conversion start of regular group. If set to ADC\+\_\+\+SOFTWARE\+\_\+\+START, external triggers are disabled. If set to external trigger source, triggering is on event rising edge by default. This parameter can be a value of \doxyref{ADC External Trigger Source Regular}{p.}{group___a_d_c___external__trigger___source___regular} \mbox{\label{struct_a_d_c___init_type_def_ace2c616b80bb7f1982e8a52131a2732c}} 
...
Selects the external trigger edge of regular group. If trigger is set to ADC\+\_\+\+SOFTWARE\+\_\+\+START, this parameter is discarded. This parameter can be a value of \doxyref{ADC External Trigger Edge Regular}{p.}{group___a_d_c___external__trigger__edge___regular} \mbox{\label{struct_a_d_c___init_type_def_acc137bdcf502c586925ad8e99628b03f}} 
...
Specifies the number of discontinuous conversions in which the main sequence of regular group (parameter Nbr\+Of\+Conversion) will be subdivided. If parameter \textquotesingle{}Discontinuous\+Conv\+Mode\textquotesingle{} is disabled, this parameter is discarded. This parameter must be a number between Min\+\_\+\+Data = 1 and Max\+\_\+\+Data = 8. \mbox{\label{struct_a_d_c___init_type_def_a6613985e603e784c30fb3689f2c6fa5f}} 
...
Configures the ADC resolution. This parameter can be a value of \doxyref{ADC Resolution}{p.}{group___a_d_c___resolution} \mbox{\label{struct_a_d_c___init_type_def_a67902b5cdd3d1aa4af49654409412a08}} 
