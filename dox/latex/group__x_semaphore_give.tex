...
semphr. h 
\begin{DoxyPre}\doxyref{xSemaphoreGive( SemaphoreHandle\_t xSemaphore )}{p.}{semphr_8h_aae55761cabfa9bf85c8f4430f78c0953}\end{DoxyPre}
...
\{
   ...
   if( xSemaphore != NULL )
   \{
       if( \doxyref{xSemaphoreGive( xSemaphore )}{p.}{semphr_8h_aae55761cabfa9bf85c8f4430f78c0953} != pdTRUE )
       \{
       ...
       if( \doxyref{xSemaphoreTake( xSemaphore, ( TickType\_t ) 0 )}{p.}{semphr_8h_af116e436d2a5ae5bd72dbade2b5ea930} )
       \{
