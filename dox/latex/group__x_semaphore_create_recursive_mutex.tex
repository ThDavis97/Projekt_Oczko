...
Mutexes created using this macro can be accessed using the x\+Semaphore\+Take\+Recursive() and x\+Semaphore\+Give\+Recursive() macros. The \doxyref{x\+Semaphore\+Take()}{p.}{semphr_8h_af116e436d2a5ae5bd72dbade2b5ea930} and \doxyref{x\+Semaphore\+Give()}{p.}{semphr_8h_aae55761cabfa9bf85c8f4430f78c0953} macros must not be used.
