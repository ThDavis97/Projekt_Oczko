...
croutine. h 
\begin{DoxyPre}
BaseType\_t \doxyref{xCoRoutineCreate(                                 crCOROUTINE\_CODE pxCoRoutineCode,                                 UBaseType\_t uxPriority,                                 UBaseType\_t uxIndex                               )}{p.}{croutine_8h_ae0e03637a3d2c134e9b52006f353d8c0};\end{DoxyPre}
...
pd\+PASS if the co-\/routine was successfully created and added to a ready list, otherwise an error code defined with \doxyref{Proj\+Defs.\+h}{p.}{projdefs_8h}.
\end{DoxyReturn}
Example usage\+: 
\begin{DoxyPre}
...
static const TickType\_t uxFlashRates[ 2 ] = \{ 200, 400 \};
    ...
    \{
        ...
        \doxyref{crDELAY( xHandle, uxFlashRates[ uxIndex ] )}{p.}{croutine_8h_a05a06feb11028f2d1d440ea335f562ba};
    \}
