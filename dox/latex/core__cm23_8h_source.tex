...
\label{core__cm23_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/core\_cm23.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/core\_cm23.h}}
...
\DoxyCodeLine{1072 \} CoreDebug\_Type;}
\DoxyCodeLine{1073 }
...
\DoxyCodeLine{1320 }
\DoxyCodeLine{1327 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_EnableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1328 \{}
\DoxyCodeLine{1329   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1330   \{}
\DoxyCodeLine{1331     NVIC-\/>ISER[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1332   \}}
\DoxyCodeLine{1333 \}}
\DoxyCodeLine{1334 }
\DoxyCodeLine{1335 }
\DoxyCodeLine{1344 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetEnableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1345 \{}
\DoxyCodeLine{1346   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1347   \{}
\DoxyCodeLine{1348     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ISER[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1349   \}}
...
\DoxyCodeLine{1355 }
\DoxyCodeLine{1356 }
\DoxyCodeLine{1363 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_DisableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1364 \{}
\DoxyCodeLine{1365   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1366   \{}
\DoxyCodeLine{1367     NVIC-\/>ICER[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1368     \_\_DSB();}
\DoxyCodeLine{1369     \_\_ISB();}
\DoxyCodeLine{1370   \}}
\DoxyCodeLine{1371 \}}
\DoxyCodeLine{1372 }
\DoxyCodeLine{1373 }
\DoxyCodeLine{1382 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1383 \{}
\DoxyCodeLine{1384   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1385   \{}
\DoxyCodeLine{1386     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ISPR[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1387   \}}
...
\DoxyCodeLine{1393 }
\DoxyCodeLine{1394 }
\DoxyCodeLine{1401 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1402 \{}
\DoxyCodeLine{1403   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1404   \{}
\DoxyCodeLine{1405     NVIC-\/>ISPR[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1406   \}}
\DoxyCodeLine{1407 \}}
\DoxyCodeLine{1408 }
\DoxyCodeLine{1409 }
\DoxyCodeLine{1416 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_ClearPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1417 \{}
\DoxyCodeLine{1418   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1419   \{}
\DoxyCodeLine{1420     NVIC-\/>ICPR[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1421   \}}
\DoxyCodeLine{1422 \}}
\DoxyCodeLine{1423 }
\DoxyCodeLine{1424 }
\DoxyCodeLine{1433 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetActive(IRQn\_Type IRQn)}
\DoxyCodeLine{1434 \{}
\DoxyCodeLine{1435   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1436   \{}
\DoxyCodeLine{1437     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>IABR[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1438   \}}
...
\DoxyCodeLine{1455 \_\_STATIC\_INLINE uint32\_t NVIC\_GetTargetState(IRQn\_Type IRQn)}
\DoxyCodeLine{1456 \{}
\DoxyCodeLine{1457   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1458   \{}
\DoxyCodeLine{1459     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ITNS[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1460   \}}
...
\DoxyCodeLine{1466 }
\DoxyCodeLine{1467 }
\DoxyCodeLine{1476 \_\_STATIC\_INLINE uint32\_t NVIC\_SetTargetState(IRQn\_Type IRQn)}
\DoxyCodeLine{1477 \{}
\DoxyCodeLine{1478   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1479   \{}
\DoxyCodeLine{1480     NVIC-\/>ITNS[(((uint32\_t)IRQn) >> 5UL)] |=  ((uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL)));}
\DoxyCodeLine{1481     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ITNS[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1482   \}}
...
\DoxyCodeLine{1488 }
\DoxyCodeLine{1489 }
\DoxyCodeLine{1498 \_\_STATIC\_INLINE uint32\_t NVIC\_ClearTargetState(IRQn\_Type IRQn)}
\DoxyCodeLine{1499 \{}
\DoxyCodeLine{1500   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1501   \{}
\DoxyCodeLine{1502     NVIC-\/>ITNS[(((uint32\_t)IRQn) >> 5UL)] \&= \string~((uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL)));}
\DoxyCodeLine{1503     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ITNS[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1504   \}}
...
\DoxyCodeLine{1511 }
\DoxyCodeLine{1512 }
\DoxyCodeLine{1522 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetPriority(IRQn\_Type IRQn, uint32\_t priority)}
\DoxyCodeLine{1523 \{}
\DoxyCodeLine{1524   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1525   \{}
\DoxyCodeLine{1526     NVIC-\/>IPR[\_IP\_IDX(IRQn)]  = ((uint32\_t)(NVIC-\/>IPR[\_IP\_IDX(IRQn)]  \& \string~(0xFFUL << \_BIT\_SHIFT(IRQn))) |}
\DoxyCodeLine{1527        (((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL) << \_BIT\_SHIFT(IRQn)));}
\DoxyCodeLine{1528   \}}
\DoxyCodeLine{1529   \textcolor{keywordflow}{else}}
\DoxyCodeLine{1530   \{}
\DoxyCodeLine{1531     SCB-\/>SHPR[\_SHP\_IDX(IRQn)] = ((uint32\_t)(SCB-\/>SHPR[\_SHP\_IDX(IRQn)] \& \string~(0xFFUL << \_BIT\_SHIFT(IRQn))) |}
\DoxyCodeLine{1532        (((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL) << \_BIT\_SHIFT(IRQn)));}
\DoxyCodeLine{1533   \}}
\DoxyCodeLine{1534 \}}
\DoxyCodeLine{1535 }
\DoxyCodeLine{1536 }
\DoxyCodeLine{1546 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetPriority(IRQn\_Type IRQn)}
\DoxyCodeLine{1547 \{}
\DoxyCodeLine{1548 }
\DoxyCodeLine{1549   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1550   \{}
\DoxyCodeLine{1551     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>IPR[ \_IP\_IDX(IRQn)] >> \_BIT\_SHIFT(IRQn) ) \& (uint32\_t)0xFFUL) >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1552   \}}
\DoxyCodeLine{1553   \textcolor{keywordflow}{else}}
\DoxyCodeLine{1554   \{}
\DoxyCodeLine{1555     \textcolor{keywordflow}{return}((uint32\_t)(((SCB-\/>SHPR[\_SHP\_IDX(IRQn)] >> \_BIT\_SHIFT(IRQn) ) \& (uint32\_t)0xFFUL) >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1556   \}}
\DoxyCodeLine{1557 \}}
\DoxyCodeLine{1558 }
\DoxyCodeLine{1559 }
\DoxyCodeLine{1571 \_\_STATIC\_INLINE uint32\_t NVIC\_EncodePriority (uint32\_t PriorityGroup, uint32\_t PreemptPriority, uint32\_t SubPriority)}
\DoxyCodeLine{1572 \{}
...
\DoxyCodeLine{1576 }
\DoxyCodeLine{1577   PreemptPriorityBits = ((7UL -\/ PriorityGroupTmp) > (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) ? (uint32\_t)(\_\_NVIC\_PRIO\_BITS) : (uint32\_t)(7UL -\/ PriorityGroupTmp);}
\DoxyCodeLine{1578   SubPriorityBits     = ((PriorityGroupTmp + (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) < (uint32\_t)7UL) ? (uint32\_t)0UL : (uint32\_t)((PriorityGroupTmp -\/ 7UL) + (uint32\_t)(\_\_NVIC\_PRIO\_BITS));}
\DoxyCodeLine{1579 }
...
\DoxyCodeLine{1585 }
\DoxyCodeLine{1586 }
\DoxyCodeLine{1598 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} NVIC\_DecodePriority (uint32\_t Priority, uint32\_t PriorityGroup, uint32\_t* \textcolor{keyword}{const} pPreemptPriority, uint32\_t* \textcolor{keyword}{const} pSubPriority)}
\DoxyCodeLine{1599 \{}
...
\DoxyCodeLine{1603 }
\DoxyCodeLine{1604   PreemptPriorityBits = ((7UL -\/ PriorityGroupTmp) > (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) ? (uint32\_t)(\_\_NVIC\_PRIO\_BITS) : (uint32\_t)(7UL -\/ PriorityGroupTmp);}
\DoxyCodeLine{1605   SubPriorityBits     = ((PriorityGroupTmp + (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) < (uint32\_t)7UL) ? (uint32\_t)0UL : (uint32\_t)((PriorityGroupTmp -\/ 7UL) + (uint32\_t)(\_\_NVIC\_PRIO\_BITS));}
\DoxyCodeLine{1606 }
...
\DoxyCodeLine{1610 }
\DoxyCodeLine{1611 }
\DoxyCodeLine{1622 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetVector(IRQn\_Type IRQn, uint32\_t vector)}
\DoxyCodeLine{1623 \{}
\DoxyCodeLine{1624 \textcolor{preprocessor}{\#if defined (\_\_VTOR\_PRESENT) \&\& (\_\_VTOR\_PRESENT == 1U)}}
\DoxyCodeLine{1625   uint32\_t *vectors = (uint32\_t *)SCB-\/>VTOR;}
...
\DoxyCodeLine{1631 }
\DoxyCodeLine{1632 }
\DoxyCodeLine{1641 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetVector(IRQn\_Type IRQn)}
\DoxyCodeLine{1642 \{}
\DoxyCodeLine{1643 \textcolor{preprocessor}{\#if defined (\_\_VTOR\_PRESENT) \&\& (\_\_VTOR\_PRESENT == 1U)}}
\DoxyCodeLine{1644   uint32\_t *vectors = (uint32\_t *)SCB-\/>VTOR;}
...
\DoxyCodeLine{1650 }
\DoxyCodeLine{1651 }
\DoxyCodeLine{1656 \_\_NO\_RETURN \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SystemReset(\textcolor{keywordtype}{void})}
\DoxyCodeLine{1657 \{}
\DoxyCodeLine{1658   \_\_DSB();                                                          \textcolor{comment}{/* Ensure all outstanding memory accesses included}}
\DoxyCodeLine{1659 \textcolor{comment}{                                                                       buffered write are completed before reset */}}
\DoxyCodeLine{1660   SCB-\/>AIRCR  = ((0x5FAUL << SCB\_AIRCR\_VECTKEY\_Pos) |}
\DoxyCodeLine{1661                  SCB\_AIRCR\_SYSRESETREQ\_Msk);}
\DoxyCodeLine{1662   \_\_DSB();                                                          \textcolor{comment}{/* Ensure completion of memory access */}}
\DoxyCodeLine{1663 }
\DoxyCodeLine{1664   \textcolor{keywordflow}{for}(;;)                                                           \textcolor{comment}{/* wait until reset */}}
\DoxyCodeLine{1665   \{}
\DoxyCodeLine{1666     \_\_NOP();}
\DoxyCodeLine{1667   \}}
\DoxyCodeLine{1668 \}}
\DoxyCodeLine{1669 }
\DoxyCodeLine{1670 \textcolor{preprocessor}{\#if defined (\_\_ARM\_FEATURE\_CMSE) \&\& (\_\_ARM\_FEATURE\_CMSE == 3U)}}
\DoxyCodeLine{1677 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} TZ\_NVIC\_EnableIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1678 \{}
...
\DoxyCodeLine{1684 }
\DoxyCodeLine{1685 }
\DoxyCodeLine{1694 \_\_STATIC\_INLINE uint32\_t TZ\_NVIC\_GetEnableIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1695 \{}
...
\DoxyCodeLine{1705 }
\DoxyCodeLine{1706 }
\DoxyCodeLine{1713 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} TZ\_NVIC\_DisableIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1714 \{}
...
\DoxyCodeLine{1720 }
\DoxyCodeLine{1721 }
\DoxyCodeLine{1730 \_\_STATIC\_INLINE uint32\_t TZ\_NVIC\_GetPendingIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1731 \{}
...
\DoxyCodeLine{1741 }
\DoxyCodeLine{1742 }
\DoxyCodeLine{1749 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} TZ\_NVIC\_SetPendingIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1750 \{}
...
\DoxyCodeLine{1756 }
\DoxyCodeLine{1757 }
\DoxyCodeLine{1764 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} TZ\_NVIC\_ClearPendingIRQ\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1765 \{}
...
\DoxyCodeLine{1771 }
\DoxyCodeLine{1772 }
\DoxyCodeLine{1781 \_\_STATIC\_INLINE uint32\_t TZ\_NVIC\_GetActive\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1782 \{}
...
\DoxyCodeLine{1792 }
\DoxyCodeLine{1793 }
\DoxyCodeLine{1803 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} TZ\_NVIC\_SetPriority\_NS(IRQn\_Type IRQn, uint32\_t priority)}
\DoxyCodeLine{1804 \{}
...
\DoxyCodeLine{1808        (((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL) << \_BIT\_SHIFT(IRQn)));}
\DoxyCodeLine{1809   \}}
...
\DoxyCodeLine{1813        (((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL) << \_BIT\_SHIFT(IRQn)));}
\DoxyCodeLine{1814   \}}
\DoxyCodeLine{1815 \}}
\DoxyCodeLine{1816 }
\DoxyCodeLine{1817 }
\DoxyCodeLine{1826 \_\_STATIC\_INLINE uint32\_t TZ\_NVIC\_GetPriority\_NS(IRQn\_Type IRQn)}
\DoxyCodeLine{1827 \{}
\DoxyCodeLine{1828 }
\DoxyCodeLine{1829   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1830   \{}
\DoxyCodeLine{1831     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC\_NS-\/>IPR[ \_IP\_IDX(IRQn)] >> \_BIT\_SHIFT(IRQn) ) \& (uint32\_t)0xFFUL) >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1832   \}}
\DoxyCodeLine{1833   \textcolor{keywordflow}{else}}
\DoxyCodeLine{1834   \{}
\DoxyCodeLine{1835     \textcolor{keywordflow}{return}((uint32\_t)(((SCB\_NS-\/>SHPR[\_SHP\_IDX(IRQn)] >> \_BIT\_SHIFT(IRQn) ) \& (uint32\_t)0xFFUL) >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1836   \}}
\DoxyCodeLine{1837 \}}
...
\DoxyCodeLine{1866 \_\_STATIC\_INLINE uint32\_t SCB\_GetFPUType(\textcolor{keywordtype}{void})}
\DoxyCodeLine{1867 \{}
...
\DoxyCodeLine{1935 \{}
\DoxyCodeLine{1936   \textcolor{keywordflow}{if} ((ticks -\/ 1UL) > SysTick\_LOAD\_RELOAD\_Msk)}
\DoxyCodeLine{1937   \{}
\DoxyCodeLine{1938     \textcolor{keywordflow}{return} (1UL);                                                   \textcolor{comment}{/* Reload value impossible */}}
\DoxyCodeLine{1939   \}}
\DoxyCodeLine{1940 }
\DoxyCodeLine{1941   SysTick-\/>LOAD  = (uint32\_t)(ticks -\/ 1UL);                         \textcolor{comment}{/* set reload register */}}
\DoxyCodeLine{1942   NVIC\_SetPriority (SysTick\_IRQn, (1UL << \_\_NVIC\_PRIO\_BITS) -\/ 1UL); \textcolor{comment}{/* set Priority for Systick Interrupt */}}
\DoxyCodeLine{1943   SysTick-\/>VAL   = 0UL;                                             \textcolor{comment}{/* Load the SysTick Counter Value */}}
\DoxyCodeLine{1944   SysTick-\/>CTRL  = SysTick\_CTRL\_CLKSOURCE\_Msk |}
\DoxyCodeLine{1945                    SysTick\_CTRL\_TICKINT\_Msk   |}
\DoxyCodeLine{1946                    SysTick\_CTRL\_ENABLE\_Msk;                         \textcolor{comment}{/* Enable SysTick IRQ and SysTick Timer */}}
...
\DoxyCodeLine{1964 \{}
\DoxyCodeLine{1965   \textcolor{keywordflow}{if} ((ticks -\/ 1UL) > SysTick\_LOAD\_RELOAD\_Msk)}
\DoxyCodeLine{1966   \{}
...
\DoxyCodeLine{1971   TZ\_NVIC\_SetPriority\_NS (SysTick\_IRQn, (1UL << \_\_NVIC\_PRIO\_BITS) -\/ 1UL); \textcolor{comment}{/* set Priority for Systick Interrupt */}}
\DoxyCodeLine{1972   SysTick\_NS-\/>VAL   = 0UL;                                                \textcolor{comment}{/* Load the SysTick Counter Value */}}
\DoxyCodeLine{1973   SysTick\_NS-\/>CTRL  = SysTick\_CTRL\_CLKSOURCE\_Msk |}
\DoxyCodeLine{1974                       SysTick\_CTRL\_TICKINT\_Msk   |}
\DoxyCodeLine{1975                       SysTick\_CTRL\_ENABLE\_Msk;                            \textcolor{comment}{/* Enable SysTick IRQ and SysTick Timer */}}
