...
queue. h 
\begin{DoxyPre}
BaseType\_t \doxyref{xQueueReceive(                              QueueHandle\_t xQueue,                              void *pvBuffer,                              TickType\_t xTicksToWait                         )}{p.}{queue_8h_ae8364d988c6f9b63c771cc2b3dfe5df9};\end{DoxyPre}
...
\hline
{\em x\+Ticks\+To\+Wait} & The maximum amount of time the task should block waiting for an item to receive should the queue be empty at the time of the call. \doxyref{x\+Queue\+Receive()}{p.}{queue_8h_ae8364d988c6f9b63c771cc2b3dfe5df9} will return immediately if x\+Ticks\+To\+Wait is zero and the queue is empty. The time is defined in tick periods so the constant port\+TICK\+\_\+\+PERIOD\+\_\+\+MS should be used to convert to real time if this is required.\\
\hline
\end{DoxyParams}
