...
pd\+PASS if the task was successfully created and added to a ready list, otherwise an error code defined in the file \doxyref{projdefs.\+h}{p.}{projdefs_8h}
\end{DoxyReturn}
Example usage\+: 
\begin{DoxyPre}
...
int \doxyref{main( void )}{p.}{main_8c_a840291bc02cba5474a4cb46a9b9566fe}
\{
TaskHandle\_t xHandle;
    ...
    // Start the scheduler.
    \doxyref{vTaskStartScheduler()}{p.}{task_8h_aaf9dca1065c60abdeb309d56ab7293cb};
...
task. h 
\begin{DoxyPre}
 void \doxyref{vTaskAllocateMPURegions( TaskHandle\_t xTask, const MemoryRegion\_t * const pxRegions )}{p.}{task_8h_ad889595baff9faf9efe02f3696825409};\end{DoxyPre}


Memory regions are assigned to a restricted task when the task is created by a call to x\+Task\+Create\+Restricted(). These regions can be redefined using \doxyref{v\+Task\+Allocate\+MPURegions()}{p.}{task_8h_ad889595baff9faf9efe02f3696825409}.
...
\{
    ...
    // xAltRegions const struct above.  Use a call to \doxyref{vTaskAllocateMPURegions()}{p.}{task_8h_ad889595baff9faf9efe02f3696825409}
