...
\begin{DoxyPre}
MessageBufferHandle\_t \doxyref{xMessageBufferCreateStatic( size\_t xBufferSizeBytes,                                                   uint8\_t *pucMessageBufferStorageArea,                                                   StaticMessageBuffer\_t *pxStaticMessageBuffer )}{p.}{message__buffer_8h_acc84f4a15dbd39ecbad35f7337e78b2c};
\end{DoxyPre}
 Creates a new message buffer using statically allocated memory. See \doxyref{x\+Message\+Buffer\+Create()}{p.}{message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36} for a version that uses dynamically allocated memory.
...
MessageBufferHandle\_t xMessageBuffer;
    ...
    xMessageBuffer = \doxyref{xMessageBufferCreateStatic( sizeof( ucBufferStorage ),                                                  ucBufferStorage,                                                  \&xMessageBufferStruct )}{p.}{message__buffer_8h_acc84f4a15dbd39ecbad35f7337e78b2c};
