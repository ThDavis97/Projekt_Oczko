...
\label{cmsis__gcc_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/cmsis\_gcc.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/cmsis\_gcc.h}}
...
\DoxyCodeLine{129 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_enable\_irq(\textcolor{keywordtype}{void})}
\DoxyCodeLine{130 \{}
\DoxyCodeLine{131   \_\_ASM \textcolor{keyword}{volatile} (\textcolor{stringliteral}{"{}cpsie i"{}} : : : \textcolor{stringliteral}{"{}memory"{}});}
\DoxyCodeLine{132 \}}
\DoxyCodeLine{133 }
\DoxyCodeLine{134 }
\DoxyCodeLine{140 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_disable\_irq(\textcolor{keywordtype}{void})}
\DoxyCodeLine{141 \{}
\DoxyCodeLine{142   \_\_ASM \textcolor{keyword}{volatile} (\textcolor{stringliteral}{"{}cpsid i"{}} : : : \textcolor{stringliteral}{"{}memory"{}});}
\DoxyCodeLine{143 \}}
\DoxyCodeLine{144 }
\DoxyCodeLine{145 }
\DoxyCodeLine{151 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_CONTROL(\textcolor{keywordtype}{void})}
\DoxyCodeLine{152 \{}
...
\DoxyCodeLine{174 }
\DoxyCodeLine{175 }
\DoxyCodeLine{181 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_set\_CONTROL(uint32\_t control)}
\DoxyCodeLine{182 \{}
...
\DoxyCodeLine{198 }
\DoxyCodeLine{199 }
\DoxyCodeLine{205 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_IPSR(\textcolor{keywordtype}{void})}
\DoxyCodeLine{206 \{}
...
\DoxyCodeLine{212 }
\DoxyCodeLine{213 }
\DoxyCodeLine{219 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_APSR(\textcolor{keywordtype}{void})}
\DoxyCodeLine{220 \{}
...
\DoxyCodeLine{226 }
\DoxyCodeLine{227 }
\DoxyCodeLine{233 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_xPSR(\textcolor{keywordtype}{void})}
\DoxyCodeLine{234 \{}
...
\DoxyCodeLine{240 }
\DoxyCodeLine{241 }
\DoxyCodeLine{247 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_PSP(\textcolor{keywordtype}{void})}
\DoxyCodeLine{248 \{}
...
\DoxyCodeLine{270 }
\DoxyCodeLine{271 }
\DoxyCodeLine{277 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_set\_PSP(uint32\_t topOfProcStack)}
\DoxyCodeLine{278 \{}
...
\DoxyCodeLine{294 }
\DoxyCodeLine{295 }
\DoxyCodeLine{301 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_MSP(\textcolor{keywordtype}{void})}
\DoxyCodeLine{302 \{}
...
\DoxyCodeLine{324 }
\DoxyCodeLine{325 }
\DoxyCodeLine{331 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_set\_MSP(uint32\_t topOfMainStack)}
\DoxyCodeLine{332 \{}
...
\DoxyCodeLine{375 }
\DoxyCodeLine{376 }
\DoxyCodeLine{382 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_PRIMASK(\textcolor{keywordtype}{void})}
\DoxyCodeLine{383 \{}
...
\DoxyCodeLine{405 }
\DoxyCodeLine{406 }
\DoxyCodeLine{412 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_set\_PRIMASK(uint32\_t priMask)}
\DoxyCodeLine{413 \{}
...
\DoxyCodeLine{759 }
\DoxyCodeLine{760 }
\DoxyCodeLine{766 \_\_STATIC\_FORCEINLINE uint32\_t \_\_get\_FPSCR(\textcolor{keywordtype}{void})}
\DoxyCodeLine{767 \{}
...
\DoxyCodeLine{785 }
\DoxyCodeLine{786 }
\DoxyCodeLine{792 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_set\_FPSCR(uint32\_t fpscr)}
\DoxyCodeLine{793 \{}
...
\DoxyCodeLine{858 }
\DoxyCodeLine{859 }
\DoxyCodeLine{866 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_ISB(\textcolor{keywordtype}{void})}
\DoxyCodeLine{867 \{}
\DoxyCodeLine{868   \_\_ASM \textcolor{keyword}{volatile} (\textcolor{stringliteral}{"{}isb 0xF"{}}:::\textcolor{stringliteral}{"{}memory"{}});}
\DoxyCodeLine{869 \}}
\DoxyCodeLine{870 }
\DoxyCodeLine{871 }
\DoxyCodeLine{877 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_DSB(\textcolor{keywordtype}{void})}
\DoxyCodeLine{878 \{}
\DoxyCodeLine{879   \_\_ASM \textcolor{keyword}{volatile} (\textcolor{stringliteral}{"{}dsb 0xF"{}}:::\textcolor{stringliteral}{"{}memory"{}});}
\DoxyCodeLine{880 \}}
\DoxyCodeLine{881 }
\DoxyCodeLine{882 }
\DoxyCodeLine{888 \_\_STATIC\_FORCEINLINE \textcolor{keywordtype}{void} \_\_DMB(\textcolor{keywordtype}{void})}
\DoxyCodeLine{889 \{}
\DoxyCodeLine{890   \_\_ASM \textcolor{keyword}{volatile} (\textcolor{stringliteral}{"{}dmb 0xF"{}}:::\textcolor{stringliteral}{"{}memory"{}});}
\DoxyCodeLine{891 \}}
\DoxyCodeLine{892 }
\DoxyCodeLine{893 }
\DoxyCodeLine{900 \_\_STATIC\_FORCEINLINE uint32\_t \_\_REV(uint32\_t value)}
\DoxyCodeLine{901 \{}
...
\DoxyCodeLine{911 }
\DoxyCodeLine{912 }
\DoxyCodeLine{919 \_\_STATIC\_FORCEINLINE uint32\_t \_\_REV16(uint32\_t value)}
\DoxyCodeLine{920 \{}
...
\DoxyCodeLine{926 }
\DoxyCodeLine{927 }
\DoxyCodeLine{934 \_\_STATIC\_FORCEINLINE int16\_t \_\_REVSH(int16\_t value)}
\DoxyCodeLine{935 \{}
...
\DoxyCodeLine{945 }
\DoxyCodeLine{946 }
\DoxyCodeLine{954 \_\_STATIC\_FORCEINLINE uint32\_t \_\_ROR(uint32\_t op1, uint32\_t op2)}
\DoxyCodeLine{955 \{}
...
\DoxyCodeLine{973 }
\DoxyCodeLine{974 }
\DoxyCodeLine{981 \_\_STATIC\_FORCEINLINE uint32\_t \_\_RBIT(uint32\_t value)}
\DoxyCodeLine{982 \{}
...
\DoxyCodeLine{1291 }
\DoxyCodeLine{1299 \_\_STATIC\_FORCEINLINE int32\_t \_\_SSAT(int32\_t val, uint32\_t sat)}
\DoxyCodeLine{1300 \{}
...
\DoxyCodeLine{1315 \}}
\DoxyCodeLine{1316 }
\DoxyCodeLine{1324 \_\_STATIC\_FORCEINLINE uint32\_t \_\_USAT(int32\_t val, uint32\_t sat)}
\DoxyCodeLine{1325 \{}
