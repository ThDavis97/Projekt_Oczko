...
task. h 
\begin{DoxyPre}void \doxyref{vTaskList( char *pcWriteBuffer )}{p.}{task_8h_ab87abc717f34ddced76802d12588a93d};\end{DoxyPre}
...
\doxyref{v\+Task\+List()}{p.}{task_8h_ab87abc717f34ddced76802d12588a93d} calls \doxyref{ux\+Task\+Get\+System\+State()}{p.}{task_8h_aa4603f3de3d809e9beb18d10fbac005d}, then formats part of the \doxyref{ux\+Task\+Get\+System\+State()}{p.}{task_8h_aa4603f3de3d809e9beb18d10fbac005d} output into a human readable table that displays task names, states and stack usage.
...
It is recommended that production systems call \doxyref{ux\+Task\+Get\+System\+State()}{p.}{task_8h_aa4603f3de3d809e9beb18d10fbac005d} directly to get access to raw stats data, rather than indirectly through a call to \doxyref{v\+Task\+List()}{p.}{task_8h_ab87abc717f34ddced76802d12588a93d}.
