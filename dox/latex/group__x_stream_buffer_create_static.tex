...
\begin{DoxyPre}
StreamBufferHandle\_t \doxyref{xStreamBufferCreateStatic( size\_t xBufferSizeBytes,                                                 size\_t xTriggerLevelBytes,                                                 uint8\_t *pucStreamBufferStorageArea,                                                 StaticStreamBuffer\_t *pxStaticStreamBuffer )}{p.}{stream__buffer_8h_a3c248575ac1b83801db605b32a118f77};
\end{DoxyPre}
 Creates a new stream buffer using statically allocated memory. See \doxyref{x\+Stream\+Buffer\+Create()}{p.}{stream__buffer_8h_a39aa4dd8b83e2df7ded291f863fb5fed} for a version that uses dynamically allocated memory.

config\+SUPPORT\+\_\+\+STATIC\+\_\+\+ALLOCATION must be set to 1 in \doxyref{Free\+RTOSConfig.\+h}{p.}{_free_r_t_o_s_config_8h} for \doxyref{x\+Stream\+Buffer\+Create\+Static()}{p.}{stream__buffer_8h_a3c248575ac1b83801db605b32a118f77} to be available.
...
const size\_t xTriggerLevel = 1;
    ...
    xStreamBuffer = \doxyref{xStreamBufferCreateStatic( sizeof( ucBufferStorage ),                                                xTriggerLevel,                                                ucBufferStorage,                                                \&xStreamBufferStruct )}{p.}{stream__buffer_8h_a3c248575ac1b83801db605b32a118f77};
