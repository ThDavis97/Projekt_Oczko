...
\begin{DoxyPre}
MessageBufferHandle\_t \doxyref{xMessageBufferCreate( size\_t xBufferSizeBytes )}{p.}{message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36};
\end{DoxyPre}


Creates a new message buffer using dynamically allocated memory. See \doxyref{x\+Message\+Buffer\+Create\+Static()}{p.}{message__buffer_8h_acc84f4a15dbd39ecbad35f7337e78b2c} for a version that uses statically allocated memory (memory that is allocated at compile time).

config\+SUPPORT\+\_\+\+DYNAMIC\+\_\+\+ALLOCATION must be set to 1 or left undefined in \doxyref{Free\+RTOSConfig.\+h}{p.}{_free_r_t_o_s_config_8h} for \doxyref{x\+Message\+Buffer\+Create()}{p.}{message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36} to be available.
...
const size\_t xMessageBufferSizeBytes = 100;
    ...
    xMessageBuffer = \doxyref{xMessageBufferCreate( xMessageBufferSizeBytes )}{p.}{message__buffer_8h_a2959cd0e3d2bd20d46908e5c9872be36};
