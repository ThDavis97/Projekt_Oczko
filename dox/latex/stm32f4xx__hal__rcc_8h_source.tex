...
\label{stm32f4xx__hal__rcc_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/STM32F4xx\_HAL\_Driver/Inc/stm32f4xx\_hal\_rcc.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/STM32F4xx\_HAL\_Driver/Inc/stm32f4xx\_hal\_rcc.h}}
...
\DoxyCodeLine{33 \textcolor{preprocessor}{\#include "{}stm32f4xx\_hal\_rcc\_ex.h"{}}}
\DoxyCodeLine{34 }
\DoxyCodeLine{43 \textcolor{comment}{/* Exported types -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{51 \textcolor{keyword}{typedef} \textcolor{keyword}{struct}}
\DoxyCodeLine{52 \{}
\DoxyCodeLine{53   uint32\_t OscillatorType;       }
\DoxyCodeLine{56   uint32\_t HSEState;             }
\DoxyCodeLine{59   uint32\_t LSEState;             }
\DoxyCodeLine{62   uint32\_t HSIState;             }
\DoxyCodeLine{65   uint32\_t HSICalibrationValue;  }
\DoxyCodeLine{68   uint32\_t LSIState;             }
\DoxyCodeLine{71   RCC\_PLLInitTypeDef PLL;        }
\DoxyCodeLine{72 \}RCC\_OscInitTypeDef;}
\DoxyCodeLine{73 }
\DoxyCodeLine{77 \textcolor{keyword}{typedef} \textcolor{keyword}{struct}}
\DoxyCodeLine{78 \{}
\DoxyCodeLine{79   uint32\_t ClockType;             }
\DoxyCodeLine{82   uint32\_t SYSCLKSource;          }
\DoxyCodeLine{85   uint32\_t AHBCLKDivider;         }
\DoxyCodeLine{88   uint32\_t APB1CLKDivider;        }
\DoxyCodeLine{91   uint32\_t APB2CLKDivider;        }
\DoxyCodeLine{94 \}RCC\_ClkInitTypeDef;}
\DoxyCodeLine{95 }
...
\DoxyCodeLine{968 }
\DoxyCodeLine{990 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_RTC\_CLKPRESCALER(\_\_RTCCLKSource\_\_) (((\_\_RTCCLKSource\_\_) \& RCC\_BDCR\_RTCSEL) == RCC\_BDCR\_RTCSEL) ?    \(\backslash\)}}
\DoxyCodeLine{991 \textcolor{preprocessor}{                                                 MODIFY\_REG(RCC-\/>CFGR, RCC\_CFGR\_RTCPRE, ((\_\_RTCCLKSource\_\_) \& 0xFFFFCFFU)) : CLEAR\_BIT(RCC-\/>CFGR, RCC\_CFGR\_RTCPRE)}}
\DoxyCodeLine{992 }
\DoxyCodeLine{993 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_RTC\_CONFIG(\_\_RTCCLKSource\_\_) do \{ \_\_HAL\_RCC\_RTC\_CLKPRESCALER(\_\_RTCCLKSource\_\_);    \(\backslash\)}}
\DoxyCodeLine{994 \textcolor{preprocessor}{                                                    RCC-\/>BDCR |= ((\_\_RTCCLKSource\_\_) \& 0x00000FFFU);  \(\backslash\)}}
\DoxyCodeLine{995 \textcolor{preprocessor}{                                                   \} while(0U)}}
\DoxyCodeLine{996 }
\DoxyCodeLine{1004 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_GET\_RTC\_SOURCE() (READ\_BIT(RCC-\/>BDCR, RCC\_BDCR\_RTCSEL))}}
\DoxyCodeLine{1005 }
\DoxyCodeLine{1011 \textcolor{preprocessor}{\#define  \_\_HAL\_RCC\_GET\_RTC\_HSE\_PRESCALER() (READ\_BIT(RCC-\/>CFGR, RCC\_CFGR\_RTCPRE) | RCC\_BDCR\_RTCSEL)}}
\DoxyCodeLine{1012 }
\DoxyCodeLine{1018 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_BACKUPRESET\_FORCE() (*(\_\_IO uint32\_t *) RCC\_BDCR\_BDRST\_BB = ENABLE)}}
\DoxyCodeLine{1019 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_BACKUPRESET\_RELEASE() (*(\_\_IO uint32\_t *) RCC\_BDCR\_BDRST\_BB = DISABLE)}}
\DoxyCodeLine{1035 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_PLL\_ENABLE() (*(\_\_IO uint32\_t *) RCC\_CR\_PLLON\_BB = ENABLE)}}
\DoxyCodeLine{1036 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_PLL\_DISABLE() (*(\_\_IO uint32\_t *) RCC\_CR\_PLLON\_BB = DISABLE)}}
\DoxyCodeLine{1037 }
\DoxyCodeLine{1046 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_PLL\_PLLSOURCE\_CONFIG(\_\_PLLSOURCE\_\_) MODIFY\_REG(RCC-\/>PLLCFGR, RCC\_PLLCFGR\_PLLSRC, (\_\_PLLSOURCE\_\_))}}
\DoxyCodeLine{1047 }
\DoxyCodeLine{1057 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_PLL\_PLLM\_CONFIG(\_\_PLLM\_\_) MODIFY\_REG(RCC-\/>PLLCFGR, RCC\_PLLCFGR\_PLLM, (\_\_PLLM\_\_))}}
\DoxyCodeLine{1075 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_SYSCLK\_CONFIG(\_\_RCC\_SYSCLKSOURCE\_\_) MODIFY\_REG(RCC-\/>CFGR, RCC\_CFGR\_SW, (\_\_RCC\_SYSCLKSOURCE\_\_))}}
\DoxyCodeLine{1076 }
\DoxyCodeLine{1086 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_GET\_SYSCLK\_SOURCE() (RCC-\/>CFGR \& RCC\_CFGR\_SWS)}}
\DoxyCodeLine{1087 }
\DoxyCodeLine{1094 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_GET\_PLL\_OSCSOURCE() ((uint32\_t)(RCC-\/>PLLCFGR \& RCC\_PLLCFGR\_PLLSRC))}}
\DoxyCodeLine{1118 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_MCO1\_CONFIG(\_\_MCOCLKSOURCE\_\_, \_\_MCODIV\_\_) \(\backslash\)}}
\DoxyCodeLine{1119 \textcolor{preprocessor}{                 MODIFY\_REG(RCC-\/>CFGR, (RCC\_CFGR\_MCO1 | RCC\_CFGR\_MCO1PRE), ((\_\_MCOCLKSOURCE\_\_) | (\_\_MCODIV\_\_)))}}
\DoxyCodeLine{1120 }
\DoxyCodeLine{1139 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_MCO2\_CONFIG(\_\_MCOCLKSOURCE\_\_, \_\_MCODIV\_\_) \(\backslash\)}}
\DoxyCodeLine{1140 \textcolor{preprocessor}{    MODIFY\_REG(RCC-\/>CFGR, (RCC\_CFGR\_MCO2 | RCC\_CFGR\_MCO2PRE), ((\_\_MCOCLKSOURCE\_\_) | ((\_\_MCODIV\_\_) << 3U)));}}
\DoxyCodeLine{1161 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_ENABLE\_IT(\_\_INTERRUPT\_\_) (*(\_\_IO uint8\_t *) RCC\_CIR\_BYTE1\_ADDRESS |= (\_\_INTERRUPT\_\_))}}
\DoxyCodeLine{1162 }
\DoxyCodeLine{1174 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_DISABLE\_IT(\_\_INTERRUPT\_\_) (*(\_\_IO uint8\_t *) RCC\_CIR\_BYTE1\_ADDRESS \&= (uint8\_t)(\string~(\_\_INTERRUPT\_\_)))}}
\DoxyCodeLine{1175 }
\DoxyCodeLine{1188 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_CLEAR\_IT(\_\_INTERRUPT\_\_) (*(\_\_IO uint8\_t *) RCC\_CIR\_BYTE2\_ADDRESS = (\_\_INTERRUPT\_\_))}}
\DoxyCodeLine{1189 }
\DoxyCodeLine{1202 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_GET\_IT(\_\_INTERRUPT\_\_) ((RCC-\/>CIR \& (\_\_INTERRUPT\_\_)) == (\_\_INTERRUPT\_\_))}}
\DoxyCodeLine{1203 }
\DoxyCodeLine{1207 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_CLEAR\_RESET\_FLAGS() (RCC-\/>CSR |= RCC\_CSR\_RMVF)}}
\DoxyCodeLine{1208 }
\DoxyCodeLine{1227 \textcolor{preprocessor}{\#define RCC\_FLAG\_MASK  ((uint8\_t)0x1FU)}}
\DoxyCodeLine{1228 \textcolor{preprocessor}{\#define \_\_HAL\_RCC\_GET\_FLAG(\_\_FLAG\_\_) (((((((\_\_FLAG\_\_) >> 5U) == 1U)? RCC-\/>CR :((((\_\_FLAG\_\_) >> 5U) == 2U) ? RCC-\/>BDCR :((((\_\_FLAG\_\_) >> 5U) == 3U)? RCC-\/>CSR :RCC-\/>CIR))) \& (1U << ((\_\_FLAG\_\_) \& RCC\_FLAG\_MASK)))!= 0U)? 1U : 0U)}}
\DoxyCodeLine{1229 }
\DoxyCodeLine{1238 \textcolor{comment}{/* Exported functions -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{1246 \textcolor{comment}{/* Initialization and de-\/initialization functions  ******************************/}}
\DoxyCodeLine{1247 HAL\_StatusTypeDef HAL\_RCC\_DeInit(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1248 HAL\_StatusTypeDef HAL\_RCC\_OscConfig(RCC\_OscInitTypeDef *RCC\_OscInitStruct);}
\DoxyCodeLine{1249 HAL\_StatusTypeDef HAL\_RCC\_ClockConfig(RCC\_ClkInitTypeDef *RCC\_ClkInitStruct, uint32\_t FLatency);}
\DoxyCodeLine{1257 \textcolor{comment}{/* Peripheral Control functions  ************************************************/}}
\DoxyCodeLine{1258 \textcolor{keywordtype}{void}     HAL\_RCC\_MCOConfig(uint32\_t RCC\_MCOx, uint32\_t RCC\_MCOSource, uint32\_t RCC\_MCODiv);}
\DoxyCodeLine{1259 \textcolor{keywordtype}{void}     HAL\_RCC\_EnableCSS(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1260 \textcolor{keywordtype}{void}     HAL\_RCC\_DisableCSS(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1261 uint32\_t HAL\_RCC\_GetSysClockFreq(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1262 uint32\_t HAL\_RCC\_GetHCLKFreq(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1263 uint32\_t HAL\_RCC\_GetPCLK1Freq(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1264 uint32\_t HAL\_RCC\_GetPCLK2Freq(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1265 \textcolor{keywordtype}{void}     HAL\_RCC\_GetOscConfig(RCC\_OscInitTypeDef *RCC\_OscInitStruct);}
\DoxyCodeLine{1266 \textcolor{keywordtype}{void}     HAL\_RCC\_GetClockConfig(RCC\_ClkInitTypeDef *RCC\_ClkInitStruct, uint32\_t *pFLatency);}
\DoxyCodeLine{1267 }
\DoxyCodeLine{1268 \textcolor{comment}{/* CSS NMI IRQ handler */}}
\DoxyCodeLine{1269 \textcolor{keywordtype}{void} HAL\_RCC\_NMI\_IRQHandler(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1270 }
\DoxyCodeLine{1271 \textcolor{comment}{/* User Callbacks in non blocking mode (IT mode) */}}
\DoxyCodeLine{1272 \textcolor{keywordtype}{void} HAL\_RCC\_CSSCallback(\textcolor{keywordtype}{void});}
\DoxyCodeLine{1273 }
\DoxyCodeLine{1282 \textcolor{comment}{/* Private types -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{1283 \textcolor{comment}{/* Private variables -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{1284 \textcolor{comment}{/* Private constants -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{1293 \textcolor{preprocessor}{\#define RCC\_OFFSET                 (RCC\_BASE -\/ PERIPH\_BASE)}}
\DoxyCodeLine{1294 \textcolor{comment}{/* -\/-\/-\/ CR Register -\/-\/-\/ */}}
\DoxyCodeLine{1295 \textcolor{comment}{/* Alias word address of HSION bit */}}
\DoxyCodeLine{1296 \textcolor{preprocessor}{\#define RCC\_CR\_OFFSET              (RCC\_OFFSET + 0x00U)}}
\DoxyCodeLine{1297 \textcolor{preprocessor}{\#define RCC\_HSION\_BIT\_NUMBER       0x00U}}
\DoxyCodeLine{1298 \textcolor{preprocessor}{\#define RCC\_CR\_HSION\_BB            (PERIPH\_BB\_BASE + (RCC\_CR\_OFFSET * 32U) + (RCC\_HSION\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1299 \textcolor{comment}{/* Alias word address of CSSON bit */}}
\DoxyCodeLine{1300 \textcolor{preprocessor}{\#define RCC\_CSSON\_BIT\_NUMBER       0x13U}}
\DoxyCodeLine{1301 \textcolor{preprocessor}{\#define RCC\_CR\_CSSON\_BB            (PERIPH\_BB\_BASE + (RCC\_CR\_OFFSET * 32U) + (RCC\_CSSON\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1302 \textcolor{comment}{/* Alias word address of PLLON bit */}}
\DoxyCodeLine{1303 \textcolor{preprocessor}{\#define RCC\_PLLON\_BIT\_NUMBER       0x18U}}
\DoxyCodeLine{1304 \textcolor{preprocessor}{\#define RCC\_CR\_PLLON\_BB            (PERIPH\_BB\_BASE + (RCC\_CR\_OFFSET * 32U) + (RCC\_PLLON\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1305 }
\DoxyCodeLine{1306 \textcolor{comment}{/* -\/-\/-\/ BDCR Register -\/-\/-\/ */}}
\DoxyCodeLine{1307 \textcolor{comment}{/* Alias word address of RTCEN bit */}}
\DoxyCodeLine{1308 \textcolor{preprocessor}{\#define RCC\_BDCR\_OFFSET            (RCC\_OFFSET + 0x70U)}}
\DoxyCodeLine{1309 \textcolor{preprocessor}{\#define RCC\_RTCEN\_BIT\_NUMBER       0x0FU}}
\DoxyCodeLine{1310 \textcolor{preprocessor}{\#define RCC\_BDCR\_RTCEN\_BB          (PERIPH\_BB\_BASE + (RCC\_BDCR\_OFFSET * 32U) + (RCC\_RTCEN\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1311 \textcolor{comment}{/* Alias word address of BDRST bit */}}
\DoxyCodeLine{1312 \textcolor{preprocessor}{\#define RCC\_BDRST\_BIT\_NUMBER       0x10U}}
\DoxyCodeLine{1313 \textcolor{preprocessor}{\#define RCC\_BDCR\_BDRST\_BB          (PERIPH\_BB\_BASE + (RCC\_BDCR\_OFFSET * 32U) + (RCC\_BDRST\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1314 }
\DoxyCodeLine{1315 \textcolor{comment}{/* -\/-\/-\/ CSR Register -\/-\/-\/ */}}
\DoxyCodeLine{1316 \textcolor{comment}{/* Alias word address of LSION bit */}}
\DoxyCodeLine{1317 \textcolor{preprocessor}{\#define RCC\_CSR\_OFFSET             (RCC\_OFFSET + 0x74U)}}
\DoxyCodeLine{1318 \textcolor{preprocessor}{\#define RCC\_LSION\_BIT\_NUMBER        0x00U}}
\DoxyCodeLine{1319 \textcolor{preprocessor}{\#define RCC\_CSR\_LSION\_BB           (PERIPH\_BB\_BASE + (RCC\_CSR\_OFFSET * 32U) + (RCC\_LSION\_BIT\_NUMBER * 4U))}}
\DoxyCodeLine{1320 }
\DoxyCodeLine{1321 \textcolor{comment}{/* CR register byte 3 (Bits[23:16]) base address */}}
\DoxyCodeLine{1322 \textcolor{preprocessor}{\#define RCC\_CR\_BYTE2\_ADDRESS       0x40023802U}}
\DoxyCodeLine{1323 }
\DoxyCodeLine{1324 \textcolor{comment}{/* CIR register byte 2 (Bits[15:8]) base address */}}
\DoxyCodeLine{1325 \textcolor{preprocessor}{\#define RCC\_CIR\_BYTE1\_ADDRESS      ((uint32\_t)(RCC\_BASE + 0x0CU + 0x01U))}}
\DoxyCodeLine{1326 }
\DoxyCodeLine{1327 \textcolor{comment}{/* CIR register byte 3 (Bits[23:16]) base address */}}
\DoxyCodeLine{1328 \textcolor{preprocessor}{\#define RCC\_CIR\_BYTE2\_ADDRESS      ((uint32\_t)(RCC\_BASE + 0x0CU + 0x02U))}}
\DoxyCodeLine{1329 }
\DoxyCodeLine{1330 \textcolor{comment}{/* BDCR register base address */}}
\DoxyCodeLine{1331 \textcolor{preprocessor}{\#define RCC\_BDCR\_BYTE0\_ADDRESS     (PERIPH\_BASE + RCC\_BDCR\_OFFSET)}}
\DoxyCodeLine{1332 }
\DoxyCodeLine{1333 \textcolor{preprocessor}{\#define RCC\_DBP\_TIMEOUT\_VALUE      2U}}
\DoxyCodeLine{1334 \textcolor{preprocessor}{\#define RCC\_LSE\_TIMEOUT\_VALUE      LSE\_STARTUP\_TIMEOUT}}
\DoxyCodeLine{1335 }
\DoxyCodeLine{1336 \textcolor{preprocessor}{\#define HSE\_TIMEOUT\_VALUE          HSE\_STARTUP\_TIMEOUT}}
\DoxyCodeLine{1337 \textcolor{preprocessor}{\#define HSI\_TIMEOUT\_VALUE          2U  }\textcolor{comment}{/* 2 ms */}\textcolor{preprocessor}{}}
\DoxyCodeLine{1338 \textcolor{preprocessor}{\#define LSI\_TIMEOUT\_VALUE          2U  }\textcolor{comment}{/* 2 ms */}\textcolor{preprocessor}{}}
\DoxyCodeLine{1339 \textcolor{preprocessor}{\#define CLOCKSWITCH\_TIMEOUT\_VALUE  5000U }\textcolor{comment}{/* 5 s */}\textcolor{preprocessor}{}}
\DoxyCodeLine{1340 }
\DoxyCodeLine{1349 \textcolor{comment}{/* Private macros -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{1357 \textcolor{preprocessor}{\#define IS\_RCC\_OSCILLATORTYPE(OSCILLATOR) ((OSCILLATOR) <= 15U)}}
\DoxyCodeLine{1358 }
\DoxyCodeLine{1359 \textcolor{preprocessor}{\#define IS\_RCC\_HSE(HSE) (((HSE) == RCC\_HSE\_OFF) || ((HSE) == RCC\_HSE\_ON) || \(\backslash\)}}
\DoxyCodeLine{1360 \textcolor{preprocessor}{                         ((HSE) == RCC\_HSE\_BYPASS))}}
\DoxyCodeLine{1361 }
\DoxyCodeLine{1362 \textcolor{preprocessor}{\#define IS\_RCC\_LSE(LSE) (((LSE) == RCC\_LSE\_OFF) || ((LSE) == RCC\_LSE\_ON) || \(\backslash\)}}
\DoxyCodeLine{1363 \textcolor{preprocessor}{                         ((LSE) == RCC\_LSE\_BYPASS))}}
\DoxyCodeLine{1364 }
\DoxyCodeLine{1365 \textcolor{preprocessor}{\#define IS\_RCC\_HSI(HSI) (((HSI) == RCC\_HSI\_OFF) || ((HSI) == RCC\_HSI\_ON))}}
\DoxyCodeLine{1366 }
\DoxyCodeLine{1367 \textcolor{preprocessor}{\#define IS\_RCC\_LSI(LSI) (((LSI) == RCC\_LSI\_OFF) || ((LSI) == RCC\_LSI\_ON))}}
\DoxyCodeLine{1368 }
\DoxyCodeLine{1369 \textcolor{preprocessor}{\#define IS\_RCC\_PLL(PLL) (((PLL) == RCC\_PLL\_NONE) ||((PLL) == RCC\_PLL\_OFF) || ((PLL) == RCC\_PLL\_ON))}}
\DoxyCodeLine{1370 }
\DoxyCodeLine{1371 \textcolor{preprocessor}{\#define IS\_RCC\_PLLSOURCE(SOURCE) (((SOURCE) == RCC\_PLLSOURCE\_HSI) || \(\backslash\)}}
\DoxyCodeLine{1372 \textcolor{preprocessor}{                                  ((SOURCE) == RCC\_PLLSOURCE\_HSE))}}
\DoxyCodeLine{1373 }
\DoxyCodeLine{1374 \textcolor{preprocessor}{\#define IS\_RCC\_SYSCLKSOURCE(SOURCE) (((SOURCE) == RCC\_SYSCLKSOURCE\_HSI) || \(\backslash\)}}
\DoxyCodeLine{1375 \textcolor{preprocessor}{                                     ((SOURCE) == RCC\_SYSCLKSOURCE\_HSE) || \(\backslash\)}}
\DoxyCodeLine{1376 \textcolor{preprocessor}{                                     ((SOURCE) == RCC\_SYSCLKSOURCE\_PLLCLK) || \(\backslash\)}}
\DoxyCodeLine{1377 \textcolor{preprocessor}{                                     ((SOURCE) == RCC\_SYSCLKSOURCE\_PLLRCLK))}}
\DoxyCodeLine{1378 }
\DoxyCodeLine{1379 \textcolor{preprocessor}{\#define IS\_RCC\_RTCCLKSOURCE(\_\_SOURCE\_\_) (((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_LSE) || \(\backslash\)}}
\DoxyCodeLine{1380 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_LSI) || \(\backslash\)}}
\DoxyCodeLine{1381 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV2) || \(\backslash\)}}
\DoxyCodeLine{1382 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV3) || \(\backslash\)}}
\DoxyCodeLine{1383 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV4) || \(\backslash\)}}
\DoxyCodeLine{1384 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV5) || \(\backslash\)}}
\DoxyCodeLine{1385 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV6) || \(\backslash\)}}
\DoxyCodeLine{1386 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV7) || \(\backslash\)}}
\DoxyCodeLine{1387 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV8) || \(\backslash\)}}
\DoxyCodeLine{1388 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV9) || \(\backslash\)}}
\DoxyCodeLine{1389 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV10) || \(\backslash\)}}
\DoxyCodeLine{1390 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV11) || \(\backslash\)}}
\DoxyCodeLine{1391 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV12) || \(\backslash\)}}
\DoxyCodeLine{1392 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV13) || \(\backslash\)}}
\DoxyCodeLine{1393 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV14) || \(\backslash\)}}
\DoxyCodeLine{1394 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV15) || \(\backslash\)}}
\DoxyCodeLine{1395 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV16) || \(\backslash\)}}
\DoxyCodeLine{1396 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV17) || \(\backslash\)}}
\DoxyCodeLine{1397 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV18) || \(\backslash\)}}
\DoxyCodeLine{1398 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV19) || \(\backslash\)}}
\DoxyCodeLine{1399 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV20) || \(\backslash\)}}
\DoxyCodeLine{1400 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV21) || \(\backslash\)}}
\DoxyCodeLine{1401 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV22) || \(\backslash\)}}
\DoxyCodeLine{1402 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV23) || \(\backslash\)}}
\DoxyCodeLine{1403 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV24) || \(\backslash\)}}
\DoxyCodeLine{1404 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV25) || \(\backslash\)}}
\DoxyCodeLine{1405 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV26) || \(\backslash\)}}
\DoxyCodeLine{1406 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV27) || \(\backslash\)}}
\DoxyCodeLine{1407 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV28) || \(\backslash\)}}
\DoxyCodeLine{1408 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV29) || \(\backslash\)}}
\DoxyCodeLine{1409 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV30) || \(\backslash\)}}
\DoxyCodeLine{1410 \textcolor{preprocessor}{                                         ((\_\_SOURCE\_\_) == RCC\_RTCCLKSOURCE\_HSE\_DIV31))}}
\DoxyCodeLine{1411 }
\DoxyCodeLine{1412 \textcolor{preprocessor}{\#define IS\_RCC\_PLLM\_VALUE(VALUE) ((VALUE) <= 63U)}}
\DoxyCodeLine{1413 }
\DoxyCodeLine{1414 \textcolor{preprocessor}{\#define IS\_RCC\_PLLP\_VALUE(VALUE) (((VALUE) == 2U) || ((VALUE) == 4U) || ((VALUE) == 6U) || ((VALUE) == 8U))}}
\DoxyCodeLine{1415 }
\DoxyCodeLine{1416 \textcolor{preprocessor}{\#define IS\_RCC\_PLLQ\_VALUE(VALUE) ((2U <= (VALUE)) \&\& ((VALUE) <= 15U))}}
\DoxyCodeLine{1417 }
\DoxyCodeLine{1418 \textcolor{preprocessor}{\#define IS\_RCC\_HCLK(HCLK) (((HCLK) == RCC\_SYSCLK\_DIV1)   || ((HCLK) == RCC\_SYSCLK\_DIV2)   || \(\backslash\)}}
\DoxyCodeLine{1419 \textcolor{preprocessor}{                           ((HCLK) == RCC\_SYSCLK\_DIV4)   || ((HCLK) == RCC\_SYSCLK\_DIV8)   || \(\backslash\)}}
\DoxyCodeLine{1420 \textcolor{preprocessor}{                           ((HCLK) == RCC\_SYSCLK\_DIV16)  || ((HCLK) == RCC\_SYSCLK\_DIV64)  || \(\backslash\)}}
\DoxyCodeLine{1421 \textcolor{preprocessor}{                           ((HCLK) == RCC\_SYSCLK\_DIV128) || ((HCLK) == RCC\_SYSCLK\_DIV256) || \(\backslash\)}}
\DoxyCodeLine{1422 \textcolor{preprocessor}{                           ((HCLK) == RCC\_SYSCLK\_DIV512))}}
\DoxyCodeLine{1423 }
\DoxyCodeLine{1424 \textcolor{preprocessor}{\#define IS\_RCC\_CLOCKTYPE(CLK) ((1U <= (CLK)) \&\& ((CLK) <= 15U))}}
\DoxyCodeLine{1425 }
\DoxyCodeLine{1426 \textcolor{preprocessor}{\#define IS\_RCC\_PCLK(PCLK) (((PCLK) == RCC\_HCLK\_DIV1) || ((PCLK) == RCC\_HCLK\_DIV2) || \(\backslash\)}}
\DoxyCodeLine{1427 \textcolor{preprocessor}{                           ((PCLK) == RCC\_HCLK\_DIV4) || ((PCLK) == RCC\_HCLK\_DIV8) || \(\backslash\)}}
\DoxyCodeLine{1428 \textcolor{preprocessor}{                           ((PCLK) == RCC\_HCLK\_DIV16))}}
\DoxyCodeLine{1429 }
\DoxyCodeLine{1430 \textcolor{preprocessor}{\#define IS\_RCC\_MCO(MCOx) (((MCOx) == RCC\_MCO1) || ((MCOx) == RCC\_MCO2))}}
\DoxyCodeLine{1431 }
\DoxyCodeLine{1432 \textcolor{preprocessor}{\#define IS\_RCC\_MCO1SOURCE(SOURCE) (((SOURCE) == RCC\_MCO1SOURCE\_HSI) || ((SOURCE) == RCC\_MCO1SOURCE\_LSE) || \(\backslash\)}}
\DoxyCodeLine{1433 \textcolor{preprocessor}{                                   ((SOURCE) == RCC\_MCO1SOURCE\_HSE) || ((SOURCE) == RCC\_MCO1SOURCE\_PLLCLK))}}
\DoxyCodeLine{1434 }
\DoxyCodeLine{1435 \textcolor{preprocessor}{\#define IS\_RCC\_MCODIV(DIV) (((DIV) == RCC\_MCODIV\_1)  || ((DIV) == RCC\_MCODIV\_2) || \(\backslash\)}}
\DoxyCodeLine{1436 \textcolor{preprocessor}{                             ((DIV) == RCC\_MCODIV\_3) || ((DIV) == RCC\_MCODIV\_4) || \(\backslash\)}}
\DoxyCodeLine{1437 \textcolor{preprocessor}{                             ((DIV) == RCC\_MCODIV\_5))}}
\DoxyCodeLine{1438 \textcolor{preprocessor}{\#define IS\_RCC\_CALIBRATION\_VALUE(VALUE) ((VALUE) <= 0x1FU)}}
\DoxyCodeLine{1439 }
\DoxyCodeLine{1456 \textcolor{preprocessor}{\#ifdef \_\_cplusplus}}
\DoxyCodeLine{1457 \}}
\DoxyCodeLine{1458 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{1459 }
\DoxyCodeLine{1460 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* \_\_STM32F4xx\_HAL\_RCC\_H */}\textcolor{preprocessor}{}}
\DoxyCodeLine{1461 }
\DoxyCodeLine{1462 \textcolor{comment}{/************************ (C) COPYRIGHT STMicroelectronics *****END OF FILE****/}}
