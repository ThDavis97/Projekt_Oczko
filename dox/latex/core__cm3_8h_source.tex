...
\label{core__cm3_8h_source}\index{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/core\_cm3.h@{C:/ALL/STM32/Projekty/OczkoGierka/Drivers/CMSIS/Include/core\_cm3.h}}
...
\DoxyCodeLine{209   \{}
\DoxyCodeLine{210     uint32\_t \_reserved0:27;              }
\DoxyCodeLine{211     uint32\_t Q:1;                        }
\DoxyCodeLine{212     uint32\_t V:1;                        }
\DoxyCodeLine{213     uint32\_t C:1;                        }
\DoxyCodeLine{214     uint32\_t Z:1;                        }
\DoxyCodeLine{215     uint32\_t N:1;                        }
\DoxyCodeLine{216   \} b;                                   }
\DoxyCodeLine{217   uint32\_t w;                            }
\DoxyCodeLine{218 \} APSR\_Type;}
\DoxyCodeLine{219 }
...
\DoxyCodeLine{263     uint32\_t \_reserved0:1;               }
\DoxyCodeLine{264     uint32\_t ICI\_IT\_1:6;                 }
\DoxyCodeLine{265     uint32\_t \_reserved1:8;               }
\DoxyCodeLine{266     uint32\_t T:1;                        }
\DoxyCodeLine{267     uint32\_t ICI\_IT\_2:2;                 }
\DoxyCodeLine{268     uint32\_t Q:1;                        }
\DoxyCodeLine{269     uint32\_t V:1;                        }
\DoxyCodeLine{270     uint32\_t C:1;                        }
\DoxyCodeLine{271     uint32\_t Z:1;                        }
\DoxyCodeLine{272     uint32\_t N:1;                        }
\DoxyCodeLine{273   \} b;                                   }
\DoxyCodeLine{274   uint32\_t w;                            }
\DoxyCodeLine{275 \} xPSR\_Type;}
\DoxyCodeLine{276 }
...
\DoxyCodeLine{312   \{}
\DoxyCodeLine{313     uint32\_t nPRIV:1;                    }
\DoxyCodeLine{314     uint32\_t SPSEL:1;                    }
\DoxyCodeLine{315     uint32\_t \_reserved1:30;              }
\DoxyCodeLine{316   \} b;                                   }
\DoxyCodeLine{317   uint32\_t w;                            }
\DoxyCodeLine{318 \} CONTROL\_Type;}
\DoxyCodeLine{319 }
...
\DoxyCodeLine{700 \} SysTick\_Type;}
\DoxyCodeLine{701 }
...
\DoxyCodeLine{1260 \} CoreDebug\_Type;}
\DoxyCodeLine{1261 }
...
\DoxyCodeLine{1469 }
\DoxyCodeLine{1470 }
\DoxyCodeLine{1480 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetPriorityGrouping(uint32\_t PriorityGroup)}
\DoxyCodeLine{1481 \{}
...
\DoxyCodeLine{1484 }
\DoxyCodeLine{1485   reg\_value  =  SCB-\/>AIRCR;                                                   \textcolor{comment}{/* read old register configuration    */}}
\DoxyCodeLine{1486   reg\_value \&= \string~((uint32\_t)(SCB\_AIRCR\_VECTKEY\_Msk | SCB\_AIRCR\_PRIGROUP\_Msk)); \textcolor{comment}{/* clear bits to change               */}}
\DoxyCodeLine{1487   reg\_value  =  (reg\_value                                   |}
\DoxyCodeLine{1488                 ((uint32\_t)0x5FAUL << SCB\_AIRCR\_VECTKEY\_Pos) |}
\DoxyCodeLine{1489                 (PriorityGroupTmp << SCB\_AIRCR\_PRIGROUP\_Pos) );               \textcolor{comment}{/* Insert write key and priority group */}}
\DoxyCodeLine{1490   SCB-\/>AIRCR =  reg\_value;}
\DoxyCodeLine{1491 \}}
\DoxyCodeLine{1492 }
\DoxyCodeLine{1493 }
\DoxyCodeLine{1499 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetPriorityGrouping(\textcolor{keywordtype}{void})}
\DoxyCodeLine{1500 \{}
\DoxyCodeLine{1501   \textcolor{keywordflow}{return} ((uint32\_t)((SCB-\/>AIRCR \& SCB\_AIRCR\_PRIGROUP\_Msk) >> SCB\_AIRCR\_PRIGROUP\_Pos));}
\DoxyCodeLine{1502 \}}
\DoxyCodeLine{1503 }
\DoxyCodeLine{1504 }
\DoxyCodeLine{1511 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_EnableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1512 \{}
\DoxyCodeLine{1513   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1514   \{}
\DoxyCodeLine{1515     NVIC-\/>ISER[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1516   \}}
\DoxyCodeLine{1517 \}}
\DoxyCodeLine{1518 }
\DoxyCodeLine{1519 }
\DoxyCodeLine{1528 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetEnableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1529 \{}
\DoxyCodeLine{1530   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1531   \{}
\DoxyCodeLine{1532     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ISER[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1533   \}}
...
\DoxyCodeLine{1539 }
\DoxyCodeLine{1540 }
\DoxyCodeLine{1547 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_DisableIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1548 \{}
\DoxyCodeLine{1549   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1550   \{}
\DoxyCodeLine{1551     NVIC-\/>ICER[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1552     \_\_DSB();}
\DoxyCodeLine{1553     \_\_ISB();}
\DoxyCodeLine{1554   \}}
\DoxyCodeLine{1555 \}}
\DoxyCodeLine{1556 }
\DoxyCodeLine{1557 }
\DoxyCodeLine{1566 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1567 \{}
\DoxyCodeLine{1568   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1569   \{}
\DoxyCodeLine{1570     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>ISPR[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1571   \}}
...
\DoxyCodeLine{1577 }
\DoxyCodeLine{1578 }
\DoxyCodeLine{1585 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1586 \{}
\DoxyCodeLine{1587   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1588   \{}
\DoxyCodeLine{1589     NVIC-\/>ISPR[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1590   \}}
\DoxyCodeLine{1591 \}}
\DoxyCodeLine{1592 }
\DoxyCodeLine{1593 }
\DoxyCodeLine{1600 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_ClearPendingIRQ(IRQn\_Type IRQn)}
\DoxyCodeLine{1601 \{}
\DoxyCodeLine{1602   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1603   \{}
\DoxyCodeLine{1604     NVIC-\/>ICPR[(((uint32\_t)IRQn) >> 5UL)] = (uint32\_t)(1UL << (((uint32\_t)IRQn) \& 0x1FUL));}
\DoxyCodeLine{1605   \}}
\DoxyCodeLine{1606 \}}
\DoxyCodeLine{1607 }
\DoxyCodeLine{1608 }
\DoxyCodeLine{1617 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetActive(IRQn\_Type IRQn)}
\DoxyCodeLine{1618 \{}
\DoxyCodeLine{1619   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1620   \{}
\DoxyCodeLine{1621     \textcolor{keywordflow}{return}((uint32\_t)(((NVIC-\/>IABR[(((uint32\_t)IRQn) >> 5UL)] \& (1UL << (((uint32\_t)IRQn) \& 0x1FUL))) != 0UL) ? 1UL : 0UL));}
\DoxyCodeLine{1622   \}}
...
\DoxyCodeLine{1628 }
\DoxyCodeLine{1629 }
\DoxyCodeLine{1639 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetPriority(IRQn\_Type IRQn, uint32\_t priority)}
\DoxyCodeLine{1640 \{}
\DoxyCodeLine{1641   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1642   \{}
\DoxyCodeLine{1643     NVIC-\/>IP[((uint32\_t)IRQn)]               = (uint8\_t)((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL);}
\DoxyCodeLine{1644   \}}
\DoxyCodeLine{1645   \textcolor{keywordflow}{else}}
\DoxyCodeLine{1646   \{}
\DoxyCodeLine{1647     SCB-\/>SHP[(((uint32\_t)IRQn) \& 0xFUL)-\/4UL] = (uint8\_t)((priority << (8U -\/ \_\_NVIC\_PRIO\_BITS)) \& (uint32\_t)0xFFUL);}
\DoxyCodeLine{1648   \}}
\DoxyCodeLine{1649 \}}
\DoxyCodeLine{1650 }
\DoxyCodeLine{1651 }
\DoxyCodeLine{1661 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetPriority(IRQn\_Type IRQn)}
\DoxyCodeLine{1662 \{}
\DoxyCodeLine{1663 }
\DoxyCodeLine{1664   \textcolor{keywordflow}{if} ((int32\_t)(IRQn) >= 0)}
\DoxyCodeLine{1665   \{}
\DoxyCodeLine{1666     \textcolor{keywordflow}{return}(((uint32\_t)NVIC-\/>IP[((uint32\_t)IRQn)]               >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1667   \}}
\DoxyCodeLine{1668   \textcolor{keywordflow}{else}}
\DoxyCodeLine{1669   \{}
\DoxyCodeLine{1670     \textcolor{keywordflow}{return}(((uint32\_t)SCB-\/>SHP[(((uint32\_t)IRQn) \& 0xFUL)-\/4UL] >> (8U -\/ \_\_NVIC\_PRIO\_BITS)));}
\DoxyCodeLine{1671   \}}
\DoxyCodeLine{1672 \}}
\DoxyCodeLine{1673 }
\DoxyCodeLine{1674 }
\DoxyCodeLine{1686 \_\_STATIC\_INLINE uint32\_t NVIC\_EncodePriority (uint32\_t PriorityGroup, uint32\_t PreemptPriority, uint32\_t SubPriority)}
\DoxyCodeLine{1687 \{}
...
\DoxyCodeLine{1691 }
\DoxyCodeLine{1692   PreemptPriorityBits = ((7UL -\/ PriorityGroupTmp) > (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) ? (uint32\_t)(\_\_NVIC\_PRIO\_BITS) : (uint32\_t)(7UL -\/ PriorityGroupTmp);}
\DoxyCodeLine{1693   SubPriorityBits     = ((PriorityGroupTmp + (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) < (uint32\_t)7UL) ? (uint32\_t)0UL : (uint32\_t)((PriorityGroupTmp -\/ 7UL) + (uint32\_t)(\_\_NVIC\_PRIO\_BITS));}
\DoxyCodeLine{1694 }
...
\DoxyCodeLine{1700 }
\DoxyCodeLine{1701 }
\DoxyCodeLine{1713 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} NVIC\_DecodePriority (uint32\_t Priority, uint32\_t PriorityGroup, uint32\_t* \textcolor{keyword}{const} pPreemptPriority, uint32\_t* \textcolor{keyword}{const} pSubPriority)}
\DoxyCodeLine{1714 \{}
...
\DoxyCodeLine{1718 }
\DoxyCodeLine{1719   PreemptPriorityBits = ((7UL -\/ PriorityGroupTmp) > (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) ? (uint32\_t)(\_\_NVIC\_PRIO\_BITS) : (uint32\_t)(7UL -\/ PriorityGroupTmp);}
\DoxyCodeLine{1720   SubPriorityBits     = ((PriorityGroupTmp + (uint32\_t)(\_\_NVIC\_PRIO\_BITS)) < (uint32\_t)7UL) ? (uint32\_t)0UL : (uint32\_t)((PriorityGroupTmp -\/ 7UL) + (uint32\_t)(\_\_NVIC\_PRIO\_BITS));}
\DoxyCodeLine{1721 }
...
\DoxyCodeLine{1725 }
\DoxyCodeLine{1726 }
\DoxyCodeLine{1736 \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SetVector(IRQn\_Type IRQn, uint32\_t vector)}
\DoxyCodeLine{1737 \{}
\DoxyCodeLine{1738   uint32\_t *vectors = (uint32\_t *)SCB-\/>VTOR;}
\DoxyCodeLine{1739   vectors[(int32\_t)IRQn + NVIC\_USER\_IRQ\_OFFSET] = vector;}
\DoxyCodeLine{1740 \}}
\DoxyCodeLine{1741 }
\DoxyCodeLine{1742 }
\DoxyCodeLine{1751 \_\_STATIC\_INLINE uint32\_t \_\_NVIC\_GetVector(IRQn\_Type IRQn)}
\DoxyCodeLine{1752 \{}
\DoxyCodeLine{1753   uint32\_t *vectors = (uint32\_t *)SCB-\/>VTOR;}
\DoxyCodeLine{1754   \textcolor{keywordflow}{return} vectors[(int32\_t)IRQn + NVIC\_USER\_IRQ\_OFFSET];}
\DoxyCodeLine{1755 \}}
\DoxyCodeLine{1756 }
\DoxyCodeLine{1757 }
\DoxyCodeLine{1762 \_\_NO\_RETURN \_\_STATIC\_INLINE \textcolor{keywordtype}{void} \_\_NVIC\_SystemReset(\textcolor{keywordtype}{void})}
\DoxyCodeLine{1763 \{}
\DoxyCodeLine{1764   \_\_DSB();                                                          \textcolor{comment}{/* Ensure all outstanding memory accesses included}}
\DoxyCodeLine{1765 \textcolor{comment}{                                                                       buffered write are completed before reset */}}
\DoxyCodeLine{1766   SCB-\/>AIRCR  = (uint32\_t)((0x5FAUL << SCB\_AIRCR\_VECTKEY\_Pos)    |}
\DoxyCodeLine{1767                            (SCB-\/>AIRCR \& SCB\_AIRCR\_PRIGROUP\_Msk) |}
\DoxyCodeLine{1768                             SCB\_AIRCR\_SYSRESETREQ\_Msk    );         \textcolor{comment}{/* Keep priority group unchanged */}}
\DoxyCodeLine{1769   \_\_DSB();                                                          \textcolor{comment}{/* Ensure completion of memory access */}}
\DoxyCodeLine{1770 }
\DoxyCodeLine{1771   \textcolor{keywordflow}{for}(;;)                                                           \textcolor{comment}{/* wait until reset */}}
\DoxyCodeLine{1772   \{}
\DoxyCodeLine{1773     \_\_NOP();}
\DoxyCodeLine{1774   \}}
\DoxyCodeLine{1775 \}}
\DoxyCodeLine{1776 }
...
\DoxyCodeLine{1803 \_\_STATIC\_INLINE uint32\_t SCB\_GetFPUType(\textcolor{keywordtype}{void})}
\DoxyCodeLine{1804 \{}
...
\DoxyCodeLine{1835 \{}
\DoxyCodeLine{1836   \textcolor{keywordflow}{if} ((ticks -\/ 1UL) > SysTick\_LOAD\_RELOAD\_Msk)}
\DoxyCodeLine{1837   \{}
\DoxyCodeLine{1838     \textcolor{keywordflow}{return} (1UL);                                                   \textcolor{comment}{/* Reload value impossible */}}
\DoxyCodeLine{1839   \}}
\DoxyCodeLine{1840 }
\DoxyCodeLine{1841   SysTick-\/>LOAD  = (uint32\_t)(ticks -\/ 1UL);                         \textcolor{comment}{/* set reload register */}}
\DoxyCodeLine{1842   NVIC\_SetPriority (SysTick\_IRQn, (1UL << \_\_NVIC\_PRIO\_BITS) -\/ 1UL); \textcolor{comment}{/* set Priority for Systick Interrupt */}}
\DoxyCodeLine{1843   SysTick-\/>VAL   = 0UL;                                             \textcolor{comment}{/* Load the SysTick Counter Value */}}
\DoxyCodeLine{1844   SysTick-\/>CTRL  = SysTick\_CTRL\_CLKSOURCE\_Msk |}
\DoxyCodeLine{1845                    SysTick\_CTRL\_TICKINT\_Msk   |}
\DoxyCodeLine{1846                    SysTick\_CTRL\_ENABLE\_Msk;                         \textcolor{comment}{/* Enable SysTick IRQ and SysTick Timer */}}
...
\DoxyCodeLine{1864 \textcolor{keyword}{extern} \textcolor{keyword}{volatile} int32\_t ITM\_RxBuffer;                              }
\DoxyCodeLine{1865 \textcolor{preprocessor}{\#define                 ITM\_RXBUFFER\_EMPTY  ((int32\_t)0x5AA55AA5U) }}
\DoxyCodeLine{1876 \_\_STATIC\_INLINE uint32\_t ITM\_SendChar (uint32\_t ch)}
\DoxyCodeLine{1877 \{}
\DoxyCodeLine{1878   \textcolor{keywordflow}{if} (((ITM-\/>TCR \& ITM\_TCR\_ITMENA\_Msk) != 0UL) \&\&      \textcolor{comment}{/* ITM enabled */}}
\DoxyCodeLine{1879       ((ITM-\/>TER \& 1UL               ) != 0UL)   )     \textcolor{comment}{/* ITM Port \#0 enabled */}}
\DoxyCodeLine{1880   \{}
\DoxyCodeLine{1881     \textcolor{keywordflow}{while} (ITM-\/>PORT[0U].u32 == 0UL)}
\DoxyCodeLine{1882     \{}
\DoxyCodeLine{1883       \_\_NOP();}
\DoxyCodeLine{1884     \}}
\DoxyCodeLine{1885     ITM-\/>PORT[0U].u8 = (uint8\_t)ch;}
\DoxyCodeLine{1886   \}}
\DoxyCodeLine{1887   \textcolor{keywordflow}{return} (ch);}
\DoxyCodeLine{1888 \}}
\DoxyCodeLine{1889 }
\DoxyCodeLine{1890 }
\DoxyCodeLine{1897 \_\_STATIC\_INLINE int32\_t ITM\_ReceiveChar (\textcolor{keywordtype}{void})}
\DoxyCodeLine{1898 \{}
\DoxyCodeLine{1899   int32\_t ch = -\/1;                           \textcolor{comment}{/* no character available */}}
\DoxyCodeLine{1900 }
\DoxyCodeLine{1901   \textcolor{keywordflow}{if} (ITM\_RxBuffer != ITM\_RXBUFFER\_EMPTY)}
\DoxyCodeLine{1902   \{}
\DoxyCodeLine{1903     ch = ITM\_RxBuffer;}
\DoxyCodeLine{1904     ITM\_RxBuffer = ITM\_RXBUFFER\_EMPTY;       \textcolor{comment}{/* ready for next character */}}
\DoxyCodeLine{1905   \}}
\DoxyCodeLine{1906 }
...
\DoxyCodeLine{1909 }
\DoxyCodeLine{1910 }
\DoxyCodeLine{1917 \_\_STATIC\_INLINE int32\_t ITM\_CheckChar (\textcolor{keywordtype}{void})}
\DoxyCodeLine{1918 \{}
\DoxyCodeLine{1919 }
\DoxyCodeLine{1920   \textcolor{keywordflow}{if} (ITM\_RxBuffer == ITM\_RXBUFFER\_EMPTY)}
\DoxyCodeLine{1921   \{}
