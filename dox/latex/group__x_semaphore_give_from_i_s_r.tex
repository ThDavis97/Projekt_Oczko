...
semphr. h 
\begin{DoxyPre}
\doxyref{xSemaphoreGiveFromISR(                          SemaphoreHandle\_t xSemaphore,                          BaseType\_t *pxHigherPriorityTaskWoken                      )}{p.}{semphr_8h_a68aa43df8b2a0dbe17d05fad74670ef0}\end{DoxyPre}
...
\hline
{\em px\+Higher\+Priority\+Task\+Woken} & \doxyref{x\+Semaphore\+Give\+From\+ISR()}{p.}{semphr_8h_a68aa43df8b2a0dbe17d05fad74670ef0} will set $\ast$px\+Higher\+Priority\+Task\+Woken to pd\+TRUE if giving the semaphore caused a task to unblock, and the unblocked task has a priority higher than the currently running task. If \doxyref{x\+Semaphore\+Give\+From\+ISR()}{p.}{semphr_8h_a68aa43df8b2a0dbe17d05fad74670ef0} sets this value to pd\+TRUE then a context switch should be requested before the interrupt is exited.\\
\hline
\end{DoxyParams}
...
\{
   ...
   \{
       ...
       if( \doxyref{xSemaphoreTake( xSemaphore, LONG\_TIME )}{p.}{semphr_8h_af116e436d2a5ae5bd72dbade2b5ea930} == pdTRUE )
       \{
...
static BaseType\_t xHigherPriorityTaskWoken;
   ...
   \{
       ...
       \doxyref{xSemaphoreGiveFromISR( xSemaphore, \&xHigherPriorityTaskWoken )}{p.}{semphr_8h_a68aa43df8b2a0dbe17d05fad74670ef0};
