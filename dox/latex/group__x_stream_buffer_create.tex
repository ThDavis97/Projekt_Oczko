...
\begin{DoxyPre}
StreamBufferHandle\_t \doxyref{xStreamBufferCreate( size\_t xBufferSizeBytes, size\_t xTriggerLevelBytes )}{p.}{stream__buffer_8h_a39aa4dd8b83e2df7ded291f863fb5fed};
\end{DoxyPre}


Creates a new stream buffer using dynamically allocated memory. See \doxyref{x\+Stream\+Buffer\+Create\+Static()}{p.}{stream__buffer_8h_a3c248575ac1b83801db605b32a118f77} for a version that uses statically allocated memory (memory that is allocated at compile time).

config\+SUPPORT\+\_\+\+DYNAMIC\+\_\+\+ALLOCATION must be set to 1 or left undefined in \doxyref{Free\+RTOSConfig.\+h}{p.}{_free_r_t_o_s_config_8h} for \doxyref{x\+Stream\+Buffer\+Create()}{p.}{stream__buffer_8h_a39aa4dd8b83e2df7ded291f863fb5fed} to be available.
...
const size\_t xStreamBufferSizeBytes = 100, xTriggerLevel = 10;
    ...
    xStreamBuffer = \doxyref{xStreamBufferCreate( xStreamBufferSizeBytes, xTriggerLevel )}{p.}{stream__buffer_8h_a39aa4dd8b83e2df7ded291f863fb5fed};
