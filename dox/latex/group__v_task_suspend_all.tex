...
task. h 
\begin{DoxyPre}void \doxyref{vTaskSuspendAll( void )}{p.}{task_8h_a366b302eba79d10b5ee2a3756f0fcc43};\end{DoxyPre}
...
API functions that have the potential to cause a context switch (for example, \doxyref{v\+Task\+Delay\+Until()}{p.}{task_8h_a067da3e949e248096ec6c01f9cb75a47}, \doxyref{x\+Queue\+Send()}{p.}{queue_8h_af7eb49d3249351176992950d9185abe9}, etc.) must not be called while the scheduler is suspended.
